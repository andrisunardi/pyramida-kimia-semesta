...
namespace Dcblogdev\Dropbox\Facades {
    ...
    class Dropbox {
        ...
        {
            /** @var \Dcblogdev\Dropbox\Dropbox $instance */
         ...
         * @static
         */
        public static function disconnect($redirectPath = '/')
        {
            /** @var \Dcblogdev\Dropbox\Dropbox $instance */
            return $instance->disconnect($redirectPath);
        }
         ...
         * @return \Dcblogdev\Dropbox\return string access token
         * @static
         */
        public static function getAccessToken($returnNullNoAccessToken = null)
        {
            /** @var \Dcblogdev\Dropbox\Dropbox $instance */
            return $instance->getAccessToken($returnNullNoAccessToken);
        }
...
namespace  {
    ...
    class Dropbox extends \Dcblogdev\Dropbox\Facades\Dropbox {}
