    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            ...
            'dropbox' => \Dcblogdev\Dropbox\Dropbox::class,
    ...
    override(\config(), map([
            ...
            'app.aliases.Utils' => 'string',
            'app.roles' => 'array',
            'app.route_roles' => 'string',
            'app.cms_roles' => 'array',
            'app.route_cms_roles' => 'string',
            ...
            'dropbox.clientId' => 'NULL',
            'dropbox.clientSecret' => 'NULL',
            'dropbox.redirectUri' => 'NULL',
            'dropbox.landingUri' => 'string',
            'dropbox.accessToken' => 'string',
            'dropbox.accessType' => 'string',
            'dropbox.scopes' => 'string',
            ...
            'filesystems.disks.azure.driver' => 'string',
            'filesystems.disks.azure.connection_string' => 'string',
            'filesystems.disks.azure.container' => 'string',
            ...
            'filesystems.disks.videos.driver' => 'string',
            'filesystems.disks.videos.root' => 'string',
            'filesystems.disks.videos.url' => 'string',
            'filesystems.disks.videos.visibility' => 'string',
            'filesystems.links./Users/andrisunardi/project/pyramida-kimia-semesta/public/storage' => 'string',
            'flare.key' => 'NULL',
            ...
            'livewire-alert.alert.position' => 'string',
            'livewire-alert.alert.timer' => 'integer',
            'livewire-alert.alert.toast' => 'boolean',
            'livewire-alert.alert.showConfirmButton' => 'boolean',
            'livewire-alert.alert.timerProgressBar' => 'boolean',
            'livewire-alert.confirm.position' => 'string',
            'livewire-alert.confirm.icon' => 'string',
            'livewire-alert.confirm.toast' => 'boolean',
            'livewire-alert.confirm.timer' => 'NULL',
            'livewire-alert.confirm.showConfirmButton' => 'boolean',
            'livewire-alert.confirm.showCancelButton' => 'boolean',
            'livewire-alert.confirm.cancelButtonText' => 'string',
            'livewire-alert.confirm.confirmButtonColor' => 'string',
            'livewire-alert.confirm.cancelButtonColor' => 'string',
            ...
            'menus.0.roles' => 'string',
            'menus.0.permissions' => 'string',
            'menus.0.name' => 'string',
            'menus.0.route' => 'string',
            'menus.0.icon' => 'string',
            'menus.0.table' => 'string',
            'menus.0.sidebar' => 'boolean',
            'menus.0.subMenus' => 'array',
            'menus.1.roles' => 'string',
            'menus.1.permissions' => 'string',
            'menus.1.name' => 'string',
            'menus.1.route' => 'string',
            'menus.1.icon' => 'string',
            'menus.1.table' => 'string',
            'menus.1.sidebar' => 'boolean',
            'menus.1.subMenus' => 'array',
            'menus.2.roles' => 'string',
            'menus.2.permissions' => 'string',
            'menus.2.name' => 'string',
            'menus.2.route' => 'string',
            'menus.2.icon' => 'string',
            'menus.2.table' => 'string',
            'menus.2.sidebar' => 'boolean',
            'menus.2.subMenus' => 'array',
            'menus.3.roles' => 'string',
            'menus.3.permissions' => 'string',
            'menus.3.name' => 'string',
            'menus.3.route' => 'string',
            'menus.3.icon' => 'string',
            'menus.3.table' => 'string',
            'menus.3.sidebar' => 'boolean',
            'menus.3.subMenus' => 'array',
            'menus.4.roles' => 'string',
            'menus.4.permissions' => 'string',
            'menus.4.name' => 'string',
            'menus.4.route' => 'string',
            'menus.4.icon' => 'string',
            'menus.4.table' => 'string',
            'menus.4.sidebar' => 'boolean',
            'menus.4.subMenus' => 'array',
            'menus.5.roles' => 'string',
            'menus.5.permissions' => 'string',
            'menus.5.name' => 'string',
            'menus.5.route' => 'string',
            'menus.5.icon' => 'string',
            'menus.5.table' => 'string',
            'menus.5.sidebar' => 'boolean',
            'menus.5.subMenus' => 'array',
            'menus.6.roles' => 'string',
            'menus.6.permissions' => 'string',
            'menus.6.name' => 'string',
            'menus.6.route' => 'string',
            'menus.6.icon' => 'string',
            'menus.6.table' => 'string',
            'menus.6.sidebar' => 'boolean',
            'menus.6.subMenus' => 'array',
            'menus.7.roles' => 'string',
            'menus.7.permissions' => 'string',
            'menus.7.name' => 'string',
            'menus.7.route' => 'string',
            'menus.7.icon' => 'string',
            'menus.7.table' => 'string',
            'menus.7.sidebar' => 'boolean',
            'menus.7.subMenus' => 'array',
            'menus.8.roles' => 'string',
            'menus.8.permissions' => 'string',
            'menus.8.name' => 'string',
            'menus.8.route' => 'string',
            'menus.8.icon' => 'string',
            'menus.8.table' => 'string',
            'menus.8.sidebar' => 'boolean',
            'menus.8.subMenus' => 'array',
            'menus.9.roles' => 'string',
            'menus.9.permissions' => 'string',
            'menus.9.name' => 'string',
            'menus.9.route' => 'string',
            'menus.9.icon' => 'string',
            'menus.9.table' => 'string',
            'menus.9.sidebar' => 'boolean',
            'menus.9.subMenus' => 'array',
            'menus.10.roles' => 'string',
            'menus.10.permissions' => 'string',
            'menus.10.name' => 'string',
            'menus.10.route' => 'string',
            'menus.10.icon' => 'string',
            'menus.10.table' => 'string',
            'menus.10.sidebar' => 'boolean',
            'menus.10.subMenus' => 'array',
            'menus.11.roles' => 'string',
            'menus.11.permissions' => 'string',
            'menus.11.name' => 'string',
            'menus.11.route' => 'string',
            'menus.11.icon' => 'string',
            'menus.11.table' => 'string',
            'menus.11.sidebar' => 'boolean',
            'menus.11.subMenus' => 'array',
            'menus.12.roles' => 'string',
            'menus.12.permissions' => 'string',
            'menus.12.name' => 'string',
            'menus.12.route' => 'string',
            'menus.12.icon' => 'string',
            'menus.12.table' => 'string',
            'menus.12.sidebar' => 'boolean',
            'menus.12.subMenus' => 'array',
            'menus.13.roles' => 'string',
            'menus.13.permissions' => 'string',
            'menus.13.name' => 'string',
            'menus.13.route' => 'string',
            'menus.13.icon' => 'string',
            'menus.13.table' => 'string',
            'menus.13.sidebar' => 'boolean',
            'menus.13.subMenus' => 'array',
            'menus.14.roles' => 'string',
            'menus.14.permissions' => 'string',
            'menus.14.name' => 'string',
            'menus.14.route' => 'string',
            'menus.14.icon' => 'string',
            'menus.14.table' => 'string',
            'menus.14.sidebar' => 'boolean',
            'menus.14.subMenus' => 'array',
            'menus.15.roles' => 'string',
            'menus.15.permissions' => 'string',
            'menus.15.name' => 'string',
            'menus.15.route' => 'string',
            'menus.15.icon' => 'string',
            'menus.15.table' => 'NULL',
            'menus.15.sidebar' => 'boolean',
            'menus.15.subMenus.0.roles' => 'string',
            'menus.15.subMenus.0.permissions' => 'string',
            'menus.15.subMenus.0.name' => 'string',
            'menus.15.subMenus.0.route' => 'string',
            'menus.15.subMenus.0.icon' => 'string',
            'menus.15.subMenus.0.table' => 'NULL',
            'menus.15.subMenus.0.sidebar' => 'boolean',
            'menus.15.subMenus.1.roles' => 'string',
            'menus.15.subMenus.1.permissions' => 'string',
            'menus.15.subMenus.1.name' => 'string',
            'menus.15.subMenus.1.route' => 'string',
            'menus.15.subMenus.1.icon' => 'string',
            'menus.15.subMenus.1.table' => 'string',
            'menus.15.subMenus.1.sidebar' => 'boolean',
            'menus.15.subMenus.2.roles' => 'string',
            'menus.15.subMenus.2.permissions' => 'string',
            'menus.15.subMenus.2.name' => 'string',
            'menus.15.subMenus.2.route' => 'string',
            'menus.15.subMenus.2.icon' => 'string',
            'menus.15.subMenus.2.table' => 'string',
            'menus.15.subMenus.2.sidebar' => 'boolean',
            'menus.15.subMenus.3.roles' => 'string',
            'menus.15.subMenus.3.permissions' => 'string',
            'menus.15.subMenus.3.name' => 'string',
            'menus.15.subMenus.3.route' => 'string',
            'menus.15.subMenus.3.icon' => 'string',
            'menus.15.subMenus.3.table' => 'string',
            'menus.15.subMenus.3.sidebar' => 'boolean',
            'menus.15.subMenus.4.roles' => 'string',
            'menus.15.subMenus.4.permissions' => 'string',
            'menus.15.subMenus.4.name' => 'string',
            'menus.15.subMenus.4.route' => 'string',
            'menus.15.subMenus.4.icon' => 'string',
            'menus.15.subMenus.4.table' => 'string',
            'menus.15.subMenus.4.sidebar' => 'boolean',
            'menus.15.subMenus.5.roles' => 'string',
            'menus.15.subMenus.5.permissions' => 'string',
            'menus.15.subMenus.5.name' => 'string',
            'menus.15.subMenus.5.route' => 'string',
            'menus.15.subMenus.5.icon' => 'string',
            'menus.15.subMenus.5.table' => 'string',
            'menus.15.subMenus.5.sidebar' => 'boolean',
            ...
            'permission.permission.wildcard_permission' => 'string',
...
'app.aliases.Uri','app.aliases.Validator','app.aliases.View','app.aliases.Vite','app.aliases.Excel',
'app.aliases.Menu','app.aliases.PDF','app.aliases.permission','app.aliases.QrCode','app.aliases.role_or_permission',
'app.aliases.role','app.aliases.Utils','app.roles','app.route_roles','app.cms_roles',
'app.route_cms_roles','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver','auth.guards.web.provider',
...
'breadcrumbs.generator-class','cache.default','cache.stores.array.driver','cache.stores.array.serialize','cache.stores.database.driver',
...
'database.connections.sqlsrv.prefix_indexes','database.connections.sqlsrv.encrypt','database.connections.sqlsrv.trust_server_certificate','database.connections.testing.driver','database.connections.testing.url',
'database.connections.testing.database','database.connections.testing.prefix','database.connections.testing.foreign_key_constraints','database.migrations.table','database.migrations.update_date_on_publish',
...
'dompdf.options.allowed_remote_hosts','dompdf.options.font_height_ratio','dompdf.options.enable_html5_parser','dropbox.clientId','dropbox.clientSecret',
'dropbox.redirectUri','dropbox.landingUri','dropbox.accessToken','dropbox.accessType','dropbox.scopes',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.disks.azure.driver',
'filesystems.disks.azure.connection_string','filesystems.disks.azure.container','filesystems.disks.files.driver','filesystems.disks.files.root','filesystems.disks.files.url',
'filesystems.disks.files.visibility','filesystems.disks.images.driver','filesystems.disks.images.root','filesystems.disks.images.url','filesystems.disks.images.visibility',
'filesystems.disks.videos.driver','filesystems.disks.videos.root','filesystems.disks.videos.url','filesystems.disks.videos.visibility','filesystems.links./Users/andrisunardi/project/pyramida-kimia-semesta/public/storage',
...
'laravel-webp.default_quality','laravel-webp.default_driver','laravel-webp.drivers.cwebp.path','laravel-webp.drivers.php-gd','livewire.class_namespace',
...
'livewire.inject_morph_markers','livewire.pagination_theme','livewire-alert.alert.position','livewire-alert.alert.timer','livewire-alert.alert.toast',
'livewire-alert.alert.showConfirmButton','livewire-alert.alert.timerProgressBar','livewire-alert.confirm.position','livewire-alert.confirm.icon','livewire-alert.confirm.toast',
'livewire-alert.confirm.timer','livewire-alert.confirm.showConfirmButton','livewire-alert.confirm.showCancelButton','livewire-alert.confirm.cancelButtonText','livewire-alert.confirm.confirmButtonColor',
'livewire-alert.confirm.cancelButtonColor','log-viewer.enabled','log-viewer.api_only','log-viewer.require_auth_in_production','log-viewer.route_domain',
'log-viewer.route_path','log-viewer.back_to_system_url','log-viewer.back_to_system_label','log-viewer.timezone','log-viewer.middleware',
...
'log-viewer.cache_key_prefix','log-viewer.lazy_scan_chunk_size_in_mb','log-viewer.strip_extracted_context','log-viewer.per_page_options','logging.default',
...
'mail.from.address','mail.from.name','mail.markdown.theme','mail.markdown.paths','menus.0.roles',
'menus.0.permissions','menus.0.name','menus.0.route','menus.0.icon','menus.0.table',
'menus.0.sidebar','menus.0.subMenus','menus.1.roles','menus.1.permissions','menus.1.name',
'menus.1.route','menus.1.icon','menus.1.table','menus.1.sidebar','menus.1.subMenus',
'menus.2.roles','menus.2.permissions','menus.2.name','menus.2.route','menus.2.icon',
'menus.2.table','menus.2.sidebar','menus.2.subMenus','menus.3.roles','menus.3.permissions',
'menus.3.name','menus.3.route','menus.3.icon','menus.3.table','menus.3.sidebar',
'menus.3.subMenus','menus.4.roles','menus.4.permissions','menus.4.name','menus.4.route',
'menus.4.icon','menus.4.table','menus.4.sidebar','menus.4.subMenus','menus.5.roles',
'menus.5.permissions','menus.5.name','menus.5.route','menus.5.icon','menus.5.table',
'menus.5.sidebar','menus.5.subMenus','menus.6.roles','menus.6.permissions','menus.6.name',
'menus.6.route','menus.6.icon','menus.6.table','menus.6.sidebar','menus.6.subMenus',
'menus.7.roles','menus.7.permissions','menus.7.name','menus.7.route','menus.7.icon',
'menus.7.table','menus.7.sidebar','menus.7.subMenus','menus.8.roles','menus.8.permissions',
'menus.8.name','menus.8.route','menus.8.icon','menus.8.table','menus.8.sidebar',
'menus.8.subMenus','menus.9.roles','menus.9.permissions','menus.9.name','menus.9.route',
'menus.9.icon','menus.9.table','menus.9.sidebar','menus.9.subMenus','menus.10.roles',
'menus.10.permissions','menus.10.name','menus.10.route','menus.10.icon','menus.10.table',
'menus.10.sidebar','menus.10.subMenus','menus.11.roles','menus.11.permissions','menus.11.name',
'menus.11.route','menus.11.icon','menus.11.table','menus.11.sidebar','menus.11.subMenus',
'menus.12.roles','menus.12.permissions','menus.12.name','menus.12.route','menus.12.icon',
'menus.12.table','menus.12.sidebar','menus.12.subMenus','menus.13.roles','menus.13.permissions',
'menus.13.name','menus.13.route','menus.13.icon','menus.13.table','menus.13.sidebar',
'menus.13.subMenus','menus.14.roles','menus.14.permissions','menus.14.name','menus.14.route',
'menus.14.icon','menus.14.table','menus.14.sidebar','menus.14.subMenus','menus.15.roles',
'menus.15.permissions','menus.15.name','menus.15.route','menus.15.icon','menus.15.table',
'menus.15.sidebar','menus.15.subMenus.0.roles','menus.15.subMenus.0.permissions','menus.15.subMenus.0.name','menus.15.subMenus.0.route',
'menus.15.subMenus.0.icon','menus.15.subMenus.0.table','menus.15.subMenus.0.sidebar','menus.15.subMenus.1.roles','menus.15.subMenus.1.permissions',
'menus.15.subMenus.1.name','menus.15.subMenus.1.route','menus.15.subMenus.1.icon','menus.15.subMenus.1.table','menus.15.subMenus.1.sidebar',
'menus.15.subMenus.2.roles','menus.15.subMenus.2.permissions','menus.15.subMenus.2.name','menus.15.subMenus.2.route','menus.15.subMenus.2.icon',
'menus.15.subMenus.2.table','menus.15.subMenus.2.sidebar','menus.15.subMenus.3.roles','menus.15.subMenus.3.permissions','menus.15.subMenus.3.name',
'menus.15.subMenus.3.route','menus.15.subMenus.3.icon','menus.15.subMenus.3.table','menus.15.subMenus.3.sidebar','menus.15.subMenus.4.roles',
'menus.15.subMenus.4.permissions','menus.15.subMenus.4.name','menus.15.subMenus.4.route','menus.15.subMenus.4.icon','menus.15.subMenus.4.table',
'menus.15.subMenus.4.sidebar','menus.15.subMenus.5.roles','menus.15.subMenus.5.permissions','menus.15.subMenus.5.name','menus.15.subMenus.5.route',
'menus.15.subMenus.5.icon','menus.15.subMenus.5.table','menus.15.subMenus.5.sidebar','permission.models.permission','permission.models.role',
...
'permission.cache.store','permission.permission.wildcard_permission','pretty-routes.url','pretty-routes.middlewares','pretty-routes.debug_only',
...
'reverb.apps.apps.0.ping_interval','reverb.apps.apps.0.activity_timeout','reverb.apps.apps.0.max_message_size','sanctum.stateful','sanctum.guard',
...
'tinker.commands','tinker.alias','tinker.dont_alias','hashing.driver','hashing.bcrypt.rounds',
...
'cors.max_age','cors.supports_credentials',);
...
'team.index','team.view','partner','testimony','product.index',
'product.category','product.view','gallery','faq','career',
'article.index','article.view','contact','enquire','cms.login',
'cms.forgot-password','cms.index','cms.contact.index','cms.contact.detail','cms.article.index',
'cms.article.add','cms.article.edit','cms.article.detail','cms.product.index','cms.product.add',
'cms.product.edit','cms.product.detail','cms.product-category.index','cms.product-category.add','cms.product-category.edit',
'cms.product-category.detail','cms.gallery.index','cms.gallery.add','cms.gallery.edit','cms.gallery.detail',
'cms.gallery-category.index','cms.gallery-category.add','cms.gallery-category.edit','cms.gallery-category.detail','cms.slider.index',
'cms.slider.add','cms.slider.edit','cms.slider.detail','cms.testimony.index','cms.testimony.add',
'cms.testimony.edit','cms.testimony.detail','cms.partner.index','cms.partner.add','cms.partner.edit',
'cms.partner.detail','cms.team.index','cms.team.add','cms.team.edit','cms.team.detail',
'cms.history.index','cms.history.add','cms.history.edit','cms.history.detail','cms.career.index',
'cms.career.add','cms.career.edit','cms.career.detail','cms.career-benefit.index','cms.career-benefit.add',
'cms.career-benefit.edit','cms.career-benefit.detail','cms.faq.index','cms.faq.add','cms.faq.edit',
'cms.faq.detail','cms.office.index','cms.office.add','cms.office.edit','cms.office.detail',
'cms.configuration.index','cms.configuration.activity','cms.configuration.user.index','cms.configuration.user.add','cms.configuration.user.edit',
'cms.configuration.user.delete','cms.configuration.user.detail','cms.configuration.role.index','cms.configuration.role.add','cms.configuration.role.edit',
'cms.configuration.role.delete','cms.configuration.role.detail','cms.configuration.permission.index','cms.configuration.permission.add','cms.configuration.permission.edit',
'cms.configuration.permission.detail','cms.configuration.setting.index','cms.configuration.setting.add','cms.configuration.setting.edit','cms.configuration.setting.delete',
'cms.configuration.setting.detail','cms.profile.index','cms.profile.activity-log','cms.profile.edit-profile','cms.profile.change-password',
'cms.logout','storage.local',);
        registerArgumentsSet('views', 
'breadcrumbs::bootstrap4','breadcrumbs::bootstrap5','breadcrumbs::bulma','breadcrumbs::foundation6','breadcrumbs::materialize',
'breadcrumbs::tailwind','breadcrumbs::uikit','components.layouts.breadcrumbs','components.layouts.breadcrumbs-render','emails.contact',
'emails.database-backup-daily','errors.400','errors.401','errors.402','errors.403',
...
'errors.minimal','excel.article','excel.career','excel.career-benefit','excel.contact',
'excel.faq','excel.gallery','excel.gallery-category','excel.history','excel.office',
'excel.partner','excel.permission','excel.permission.role','excel.permission.user','excel.product',
'excel.product-category','excel.slider','excel.team','excel.testimony','layouts.body',
'layouts.cms.body','layouts.cms.css','layouts.cms.script','layouts.cms.vendors','layouts.css',
'layouts.script','layouts.vendors','livewire-charts::livewire-area-chart','livewire-charts::livewire-column-chart','livewire-charts::livewire-line-chart',
'livewire-charts::livewire-multi-column-chart','livewire-charts::livewire-multi-line-chart','livewire-charts::livewire-pie-chart','livewire-charts::livewire-radar-chart','livewire-charts::livewire-radial-chart',
'livewire-charts::livewire-tree-map-chart','livewire.about.index','livewire.article.index','livewire.article.sidebar-right','livewire.article.view',
'livewire.banner','livewire.career.index','livewire.cms.article.add','livewire.cms.article.detail','livewire.cms.article.edit',
'livewire.cms.article.index','livewire.cms.career-benefit.add','livewire.cms.career-benefit.detail','livewire.cms.career-benefit.edit','livewire.cms.career-benefit.index',
'livewire.cms.career.add','livewire.cms.career.detail','livewire.cms.career.edit','livewire.cms.career.index','livewire.cms.configuration.permission.add',
'livewire.cms.configuration.permission.detail','livewire.cms.configuration.permission.edit','livewire.cms.configuration.permission.index','livewire.cms.configuration.permission.role','livewire.cms.configuration.permission.user',
'livewire.cms.contact.detail','livewire.cms.contact.index','livewire.cms.faq.add','livewire.cms.faq.detail','livewire.cms.faq.edit',
'livewire.cms.faq.index','livewire.cms.forgot-password.index','livewire.cms.gallery-category.add','livewire.cms.gallery-category.detail','livewire.cms.gallery-category.edit',
'livewire.cms.gallery-category.index','livewire.cms.gallery.add','livewire.cms.gallery.detail','livewire.cms.gallery.edit','livewire.cms.gallery.index',
'livewire.cms.history.add','livewire.cms.history.detail','livewire.cms.history.edit','livewire.cms.history.index','livewire.cms.home.index',
'livewire.cms.home.menu','livewire.cms.layouts.error','livewire.cms.layouts.footer','livewire.cms.layouts.header','livewire.cms.layouts.language',
'livewire.cms.layouts.profile','livewire.cms.layouts.search-menu','livewire.cms.layouts.server-time','livewire.cms.layouts.sidebar','livewire.cms.layouts.theme',
'livewire.cms.loader','livewire.cms.login.index','livewire.cms.office.add','livewire.cms.office.detail','livewire.cms.office.edit',
'livewire.cms.office.index','livewire.cms.partner.add','livewire.cms.partner.detail','livewire.cms.partner.edit','livewire.cms.partner.index',
'livewire.cms.product-category.add','livewire.cms.product-category.detail','livewire.cms.product-category.edit','livewire.cms.product-category.index','livewire.cms.product.add',
'livewire.cms.product.detail','livewire.cms.product.edit','livewire.cms.product.index','livewire.cms.profile.activity-log','livewire.cms.profile.change-password',
'livewire.cms.profile.edit-profile','livewire.cms.profile.index','livewire.cms.profile.menu','livewire.cms.slider.add','livewire.cms.slider.detail',
'livewire.cms.slider.edit','livewire.cms.slider.index','livewire.cms.team.add','livewire.cms.team.detail','livewire.cms.team.edit',
'livewire.cms.team.index','livewire.cms.testimony.add','livewire.cms.testimony.detail','livewire.cms.testimony.edit','livewire.cms.testimony.index',
'livewire.contact.index','livewire.enquire.index','livewire.faq.index','livewire.featured-product','livewire.gallery.index',
'livewire.history.index','livewire.home.article','livewire.home.index','livewire.home.partner','livewire.home.product',
'livewire.home.product-category','livewire.home.slider','livewire.home.testimony','livewire.layouts.error','livewire.layouts.footer',
'livewire.layouts.header','livewire.layouts.topbar','livewire.menu-sidebar','livewire.partner.index','livewire.product.category',
'livewire.product.index','livewire.product.view','livewire.quick-contact','livewire.resource.index','livewire.sidebar-right',
'livewire.team.index','livewire.team.view','livewire.testimony.index','livewire::bootstrap','livewire::simple-bootstrap',
...
'vendor.livewire-charts.livewire-area-chart','vendor.livewire-charts.livewire-column-chart','vendor.livewire-charts.livewire-line-chart','vendor.livewire-charts.livewire-multi-column-chart','vendor.livewire-charts.livewire-multi-line-chart',
'vendor.livewire-charts.livewire-pie-chart','vendor.livewire-charts.livewire-radar-chart','vendor.livewire-charts.livewire-radial-chart','vendor.livewire-charts.livewire-tree-map-chart','vendor.livewire.bootstrap',
...
'vendors.autonumeric','vendors.bootstrap','vendors.clarity-microsoft-tag','vendors.disabled-ctrl-u-and-f12','vendors.disabled-right-click',
'vendors.disabled-right-click-image','vendors.disabled-zoom','vendors.facebook-page','vendors.font-awesome','vendors.getbutton-io',
'vendors.google-adsense','vendors.google-analytics','vendors.google-tag-manager','vendors.jquery','vendors.livechat-tawk',
'vendors.lozad','vendors.pace','vendors.select2','vendors.snowflakes','breadcrumbs::bootstrap4',
'breadcrumbs::bootstrap5','breadcrumbs::bulma','breadcrumbs::foundation6','breadcrumbs::materialize','breadcrumbs::tailwind',
'breadcrumbs::uikit','components::components.alert','components::components.button','components::components.button.active','components::components.button.cancel',
'components::components.button.deactive','components::components.button.delete','components::components.button.delete-permanent','components::components.button.disable','components::components.button.download',
'components::components.button.edit','components::components.button.excel','components::components.button.export-to-excel','components::components.button.export-to-pdf','components::components.button.inactive',
'components::components.button.pdf','components::components.button.print','components::components.button.refresh','components::components.button.restore','components::components.button.sync',
'components::components.button.upload','components::components.button.void','components::components.form.address','components::components.form.alert','components::components.form.body',
'components::components.form.boolean','components::components.form.checkbox','components::components.form.code','components::components.form.company','components::components.form.date',
'components::components.form.datetime','components::components.form.description','components::components.form.email','components::components.form.enum','components::components.form.file',
'components::components.form.icon','components::components.form.image','components::components.form.input','components::components.form.is-active','components::components.form.label',
'components::components.form.link','components::components.form.location','components::components.form.message','components::components.form.name','components::components.form.notes',
'components::components.form.number','components::components.form.password','components::components.form.percentage','components::components.form.phone','components::components.form.price',
'components::components.form.radio','components::components.form.reset','components::components.form.save','components::components.form.save-changes','components::components.form.select',
'components::components.form.subject','components::components.form.submit','components::components.form.switch','components::components.form.text','components::components.form.textarea',
'components::components.form.time','components::components.form.title','components::components.form.url','components::components.form.username','components::components.form.video',
'components::components.form.website','components::components.form.whatsapp','components::components.icon','components::components.iframe','components::components.image',
'components::components.layouts.app','components::components.layouts.breadcrumbs','components::components.layouts.breadcrumbs-render','components::components.layouts.meta','components::components.layouts.pagination',
'components::components.link','components::components.link.active','components::components.link.add','components::components.link.back','components::components.link.button',
'components::components.link.clone','components::components.link.create','components::components.link.deactive','components::components.link.delete','components::components.link.delete-permanent',
'components::components.link.delete-permanent-all','components::components.link.detail','components::components.link.download','components::components.link.edit','components::components.link.email',
'components::components.link.external-link','components::components.link.fax','components::components.link.phone','components::components.link.previous','components::components.link.print',
'components::components.link.relation','components::components.link.restore','components::components.link.restore-all','components::components.link.sms','components::components.link.store',
'components::components.link.switch','components::components.link.tel','components::components.link.total','components::components.link.trash','components::components.link.update',
'components::components.link.user','components::components.link.view','components::components.link.whatsapp','components::components.preview.file','components::components.preview.image',
'components::components.preview.video','components::components.search','components::components.search.boolean','components::components.search.date','components::components.search.datetime',
'components::components.search.enum','components::components.search.icon','components::components.search.is-active','components::components.search.select','components::components.search.time',
'components::components.video','components::components.youtube','horizon::layout','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
...
'laravel-exceptions::503','laravel-exceptions::layout','laravel-exceptions::minimal','livewire-alert::components.flash','livewire-alert::components.scripts',
'livewire-charts::livewire-area-chart','livewire-charts::livewire-column-chart','livewire-charts::livewire-line-chart','livewire-charts::livewire-multi-column-chart','livewire-charts::livewire-multi-line-chart',
'livewire-charts::livewire-pie-chart','livewire-charts::livewire-radar-chart','livewire-charts::livewire-radial-chart','livewire-charts::livewire-tree-map-chart','livewire::bootstrap',
...
'validation.uuid','validation.custom.attribute-name.rule-name','validation.attributes.company','validation.attributes.confirm_password','validation.attributes.confirm_reset',
'validation.attributes.current_password','validation.attributes.description_id','validation.attributes.description_zh','validation.attributes.description','validation.attributes.email',
'validation.attributes.guard_name','validation.attributes.image','validation.attributes.is_active','validation.attributes.message','validation.attributes.name_id',
'validation.attributes.name_zh','validation.attributes.name','validation.attributes.new_password','validation.attributes.password','validation.attributes.phone',
'validation.attributes.role','validation.attributes.search','validation.attributes.slug','validation.attributes.subject','validation.attributes.tags_id',
'validation.attributes.tags_zh','validation.attributes.user','validation.attributes.username','validation.attributes.date','validation.attributes.tags',
'validation.attributes.location','validation.attributes.location_id','validation.attributes.location_zh','validation.attributes.url','validation.attributes.link',
'validation.attributes.question','validation.attributes.question_id','validation.attributes.question_zh','validation.attributes.answer','validation.attributes.answer_id',
'validation.attributes.answer_zh','validation.attributes.address','validation.attributes.maps','validation.attributes.gallery_category_id','validation.attributes.file_coa',
'validation.attributes.file_msds','validation.attributes.product_category_id','validation.attributes.job','validation.attributes.index','validation.success',
'index.#','index.about','index.action','index.active','index.activity_log',
'index.activity','index.add','index.all_right_reserved','index.all_rights_reserved','index.all',
'index.and','index.apply_online','index.article','index.attributes','index.auto',
'index.back_to_home','index.back_to_login','index.back','index.banner','index.call',
'index.career','index.category','index.change_language','index.change_password','index.change',
'index.chinese','index.clone','index.company_profile','index.company','index.configuration',
'index.confirm_reset','index.confirm','index.contact_information','index.contact_us_if_you_have_any_questions','index.contact_us',
'index.contact','index.copyright','index.created_and_designed_by','index.created_at','index.created_by',
'index.created','index.current_password','index.dark','index.data','index.date',
'index.delete','index.description_id','index.description_zh','index.description','index.detail',
'index.download','index.edit_profile','index.edit','index.email','index.english',
'index.enquire','index.export_to_excel','index.export_to_pdf','index.failed','index.faq',
'index.featured_product','index.fields_has_been_successfully_reseted','index.find_opportunities','index.flag','index.forgot_password_failed',
'index.forgot_password_success','index.forgot_password','index.form_validation','index.format','index.frequently_asked_questions',
'index.gallery','index.get_in_touch','index.guard_name','index.has_been_successfully_added','index.has_been_successfully_changed',
'index.has_been_successfully_deleted','index.has_been_successfully_edited','index.has_been_successfully_exported','index.history','index.home',
'index.id','index.image','index.indonesia','index.last_activity','index.latest_article',
'index.learn_more','index.light','index.login_failed','index.login_has_been_successfully','index.login_success',
'index.login','index.logo','index.logout_failed','index.logout_success','index.logout',
'index.menu','index.message','index.my_profile','index.name_id','index.name_zh',
'index.name','index.new_password','index.new','index.next','index.no_data_available',
'index.no','index.not_found','index.office','index.old','index.other_articles',
'index.other_product','index.our_gallery','index.our_history','index.our_latest_product','index.our_mission',
'index.our_partner','index.our_product_category','index.our_product','index.our_team','index.our_vision',
'index.page_has_been_successfully_refreshed','index.partner','index.permission','index.phone','index.please_try_again_later',
'index.previous','index.printed_date','index.product_category','index.product','index.profile',
'index.quick_contact','index.quick_links','index.read_more','index.recent_articles','index.refresh',
'index.reserves','index.reset_filter','index.reset','index.resource','index.resources',
'index.role','index.roles_and_permissions','index.save','index.search','index.select',
'index.send_request','index.server_time','index.setting','index.size','index.slug',
'index.stay_login','index.subject','index.submit','index.success','index.tags_id',
'index.tags_zh','index.tags','index.team','index.testimony','index.thank_you_for_contacting_us_we_will_reply_to_your_message_as_soon_as_possible',
'index.thank_you_for_contacting_us','index.theme','index.total','index.trash','index.updated_at',
'index.updated_by','index.updated','index.user','index.username_or_password_is_invalid','index.username',
'index.view','index.vision_and_mission','index.warehouse','index.write_message','index.write_subject',
'index.yes','index.you_have_been_successfully_logged_out','index.your_company','index.your_email','index.your_message_has_been_received_successfully_we_appreciate_you_reaching_out_and_will_get_back_to_you_as_soon_as_possible',
'index.your_name','index.your_phone','index.your_profile_has_been_successfully_updated','index.example','index.link',
'index.location','index.location_id','index.location_zh','index.career_benefit','index.f_a_q',
'index.gallery_category','index.address','index.maps','index.file_coa','index.file_msds',
'index.slider','index.job','index.index',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_TIMEZONE',
'APP_URL','APP_DOMAIN','APP_CHARSET','APP_COLOR','APP_COLOR_CLASS',
'APP_COUNTRY','APP_LANGUAGE','APP_DATE','APP_YEAR','APP_REFRESH',
'APP_TITLE','APP_DESCRIPTION','APP_KEYWORD','APP_CREATOR','APP_LOCALE',
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','REVERB_APP_ID',
'REVERB_APP_KEY','REVERB_APP_SECRET','REVERB_HOST','REVERB_PORT','REVERB_SCHEME',
'VITE_REVERB_APP_KEY','VITE_REVERB_HOST','VITE_REVERB_PORT','VITE_REVERB_SCHEME','LOG_SLACK_WEBHOOK_URL',
'SLACK_CHANNEL','SLACK_SMS','SLACK_MAIL','AZURE_STORAGE_CONNECTION_STRING','AZURE_STORAGE_CONTAINER',
'DEPLOY_SERVER','DEPLOY_DIRECTORY','DEPLOY_BRANCH','DEPLOY_RENDER','DEPLOY_SECRET',
'FACEBOOK_PAGE','FACEBOOK_APP_ID','FACEBOOK_PAGE_ID','FACEBOOK_ADMINS','ARTICLE_PUBLISHER',
'ARTICLE_AUTHOR','OG_TYPE','OG_URL','OG_TITLE','OG_SITE_NAME',
'OG_DESCRIPTION','OG_IMAGE','OG_LOCALE','OG_LOCALE_ALTERNATE','OG_LATITUDE',
'OG_LONGITUDE','OG_IMAGE_WIDTH','OG_IMAGE_HEIGHT','GOOGLE_ADWORDS','GOOGLE_ADSENSE',
'GOOGLE_ANALYTICS','GOOGLE_MAPS_API_KEY','GOOGLE_TAG_MANAGER','GEO_REGION','GEO_PLACENAME',
'GEO_COUNTRY','GEO_POSITION','GEO_DISTRIBUTION','ICBM','MSVALIDATE_01',
'GOOGLE_SITE_VERIFICATION','NORTON_SAFEWEB_SITE_VERIFICATION','W3TECHS_VERIFICATION','WOT_VERIFICATION','CLARITY_MICROSOFT_TAG',
'P_DOMAIN_VERIFY','ALEXA_VERIFY_ID','YANDEX_VERIFICATION','MAJESTIC_SITE_VERIFICATION','BAIDU_SITE_VERIFICATION',
'APPLE_ITUNES_APP','TWITTER_TITLE','TWITTER_DESCRIPTION','TWITTER_CARD','TWITTER_SITE',
'TWITTER_CREATOR','TWITTER_URL','TWITTER_IMAGE','TWITTER_IMAGE_SRC','TWITTER_ACCOUNT_ID',
'TWITTER_APP_ID_IPAD','TWITTER_APP_ID_IPHONE','TWITTER_APP_NAME_IPAD','TWITTER_APP_NAME_IPHONE','HEADER_CONTENT_TYPE',
'HEADER_ACCEPT','HEADER_KEY','LARAVEL_PAGE_SPEED_ENABLE','LIVECHAT_TAWK','PORTFOLIO_ID',
'MIMES_IMAGE','MIMES_FILE','MIMES_VIDEO','MIMES_AUDIO','ACCEPT_IMAGE',
'ACCEPT_FILE','ACCEPT_VIDEO','ACCEPT_AUDIO','FORMAT_IMAGE','FORMAT_FILE',
'FORMAT_VIDEO','FORMAT_AUDIO','SIZE_IMAGE','SIZE_FILE','SIZE_VIDEO',
'SIZE_AUDIO','MAX_IMAGE','MAX_FILE','MAX_VIDEO','MAX_AUDIO',
'CONTACT_EMAIL','CONTACT_PHONE','CONTACT_WHATSAPP','CONTACT_ADDRESS','CONTACT_MAPS',
'CONTACT_IFRAME','FACEBOOK_NAME','FACEBOOK_URL','TWITTER_USERNAME','TWITTER_URL',
'INSTAGRAM_USERNAME','INSTAGRAM_URL','TIKTOK_USERNAME','TIKTOK_URL',);
