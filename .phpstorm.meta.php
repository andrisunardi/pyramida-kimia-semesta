...
'menus.0.sidebar','menus.0.subMenus','permission.models.permission','permission.models.role','permission.table_names.roles',
...
'cms.forgot-password','cms.index','cms.contact.index','cms.contact.add','cms.contact.clone',
'cms.contact.edit','cms.contact.delete','cms.contact.detail','cms.contact.trash','cms.contact.restore',
'cms.contact.delete-permanent','cms.contact.restore-all','cms.contact.delete-permanent-all','cms.configuration.index','cms.configuration.activity',
'cms.configuration.user.index','cms.configuration.user.add','cms.configuration.user.clone','cms.configuration.user.edit','cms.configuration.user.active',
'cms.configuration.user.delete','cms.configuration.user.delete-image','cms.configuration.user.view','cms.configuration.user.trash','cms.configuration.user.restore',
'cms.configuration.user.delete-permanent','cms.configuration.user.restore-all','cms.configuration.user.delete-permanent-all','cms.configuration.role.index','cms.configuration.role.add',
'cms.configuration.role.clone','cms.configuration.role.edit','cms.configuration.role.delete','cms.configuration.role.view','cms.configuration.permission.index',
'cms.configuration.permission.add','cms.configuration.permission.clone','cms.configuration.permission.edit','cms.configuration.permission.delete','cms.configuration.permission.view',
'cms.configuration.setting.index','cms.configuration.setting.add','cms.configuration.setting.clone','cms.configuration.setting.edit','cms.configuration.setting.active',
'cms.configuration.setting.delete','cms.configuration.setting.view','cms.configuration.setting.trash','cms.configuration.setting.restore','cms.configuration.setting.delete-permanent',
'cms.configuration.setting.restore-all','cms.configuration.setting.delete-permanent-all','cms.profile.index','cms.profile.activity-log','cms.profile.edit-profile',
...
'errors.minimal','excel.contact','layouts.body','layouts.cms.body','layouts.cms.css',
...
'livewire.cms.contact.add','livewire.cms.contact.clone','livewire.cms.contact.edit','livewire.cms.contact.index','livewire.cms.contact.trash',
'livewire.cms.contact.view','livewire.cms.forgot-password.index','livewire.cms.home.index','livewire.cms.layouts.error','livewire.cms.layouts.footer',
...
'livewire.cms.layouts.sidebar','livewire.cms.layouts.theme','livewire.cms.login.index','livewire.cms.profile.activity-log','livewire.cms.profile.change-password',
...
'components::components.link.restore-all','components::components.link.sms','components::components.link.store','components::components.link.tel','components::components.link.total',
...
'validation.attributes.message','validation.attributes.is_active','validation.attributes.search','validation.attributes.image','validation.attributes.data',
'validation.success','index.about','index.all_right_reserved','index.all_rights_reserved','index.all',
'index.and','index.article','index.back_to_home','index.banner','index.call',
'index.category','index.change_language','index.chinese','index.company_profile','index.company',
'index.contact_information','index.contact_us_if_you_have_any_questions','index.contact_us','index.contact','index.copyright',
'index.created_and_designed_by','index.data','index.download','index.email','index.english',
'index.enquire','index.faq','index.featured_product','index.form_validation','index.frequently_asked_questions',
'index.gallery','index.get_in_touch','index.history','index.home','index.indonesia',
'index.latest_article','index.learn_more','index.menu','index.message','index.name',
'index.next','index.not_found','index.office','index.other_articles','index.our_gallery',
'index.our_history','index.our_latest_product','index.our_partner','index.our_product_category','index.our_product',
'index.partner','index.phone','index.please_try_again_later','index.previous','index.product_category',
'index.product','index.quick_contact','index.quick_links','index.read_more','index.recent_articles',
'index.reserves','index.resource','index.resources','index.search','index.subject',
'index.submit','index.tags','index.testimony','index.thank_you_for_contacting_us_we_will_reply_to_your_message_as_soon_as_possible','index.thank_you_for_contacting_us',
'index.total','index.view','index.warehouse','index.write_message','index.write_subject',
...
'index.career','index.find_opportunities','index.apply_online','index.our_team','index.team',
'index.vision_and_mission','index.our_vision','index.our_mission','index.other_product','index.login',
'index.login_failed','index.username_or_password_is_invalid','index.stay_login','index.forgot_password','index.confirm_reset',
'index.back_to_login','index.send_request','index.login_success','index.forgot_password_success','index.forgot_password_failed',
'index.current_password','index.new_password','index.server_time','index.theme','index.flag',
'index.light','index.dark','index.auto','index.profile','index.activity_log',
'index.edit_profile','index.change_password','index.logout','index.logout_failed','index.logout_success',
'index.you_have_been_successfully_logged_out','index.role','index.username','index.active','index.created_by',
'index.updated_by','index.created_at','index.updated_at','index.last_activity','index.created',
'index.updated','index.attributes','index.roles_and_permissions','index.logo','index.user',
'index.my_profile','index.yes','index.no','index.reset_filter','index.trash',
'index.#','index.id','index.action','index.add','index.edit',
'index.delete','index.clone','index.login_has_been_successfully','index.no_data_available','index.refresh',
'index.page_has_been_successfully_refreshed','index.success','index.failed','index.fields_has_been_successfully_reseted','index.back',
'index.reset','index.old','index.new','index.your_profile_has_been_successfully_updated','index.image',);
