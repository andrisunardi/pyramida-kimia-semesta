...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'menus.6.subMenus.0.roles' => 'string',
            'menus.6.subMenus.0.permissions' => 'string',
            'menus.6.subMenus.0.name' => 'string',
            'menus.6.subMenus.0.route' => 'string',
            'menus.6.subMenus.0.icon' => 'string',
            'menus.6.subMenus.0.table' => 'NULL',
            'menus.6.subMenus.0.sidebar' => 'boolean',
            'menus.6.subMenus.1.roles' => 'string',
            'menus.6.subMenus.1.permissions' => 'string',
            'menus.6.subMenus.1.name' => 'string',
            'menus.6.subMenus.1.route' => 'string',
            'menus.6.subMenus.1.icon' => 'string',
            'menus.6.subMenus.1.table' => 'string',
            'menus.6.subMenus.1.sidebar' => 'boolean',
            'menus.6.subMenus.2.roles' => 'string',
            'menus.6.subMenus.2.permissions' => 'string',
            'menus.6.subMenus.2.name' => 'string',
            'menus.6.subMenus.2.route' => 'string',
            'menus.6.subMenus.2.icon' => 'string',
            'menus.6.subMenus.2.table' => 'string',
            'menus.6.subMenus.2.sidebar' => 'boolean',
            'menus.6.subMenus.3.roles' => 'string',
            'menus.6.subMenus.3.permissions' => 'string',
            'menus.6.subMenus.3.name' => 'string',
            'menus.6.subMenus.3.route' => 'string',
            'menus.6.subMenus.3.icon' => 'string',
            'menus.6.subMenus.3.table' => 'string',
            'menus.6.subMenus.3.sidebar' => 'boolean',
            'menus.6.subMenus.4.roles' => 'string',
            'menus.6.subMenus.4.permissions' => 'string',
            'menus.6.subMenus.4.name' => 'string',
            'menus.6.subMenus.4.route' => 'string',
            'menus.6.subMenus.4.icon' => 'string',
            'menus.6.subMenus.4.table' => 'string',
            'menus.6.subMenus.4.sidebar' => 'boolean',
            'menus.6.subMenus.5.roles' => 'string',
            'menus.6.subMenus.5.permissions' => 'string',
            'menus.6.subMenus.5.name' => 'string',
            'menus.6.subMenus.5.route' => 'string',
            'menus.6.subMenus.5.icon' => 'string',
            'menus.6.subMenus.5.table' => 'string',
            'menus.6.subMenus.5.sidebar' => 'boolean',
...
'menus.6.route','menus.6.icon','menus.6.table','menus.6.sidebar','menus.6.subMenus.0.roles',
'menus.6.subMenus.0.permissions','menus.6.subMenus.0.name','menus.6.subMenus.0.route','menus.6.subMenus.0.icon','menus.6.subMenus.0.table',
'menus.6.subMenus.0.sidebar','menus.6.subMenus.1.roles','menus.6.subMenus.1.permissions','menus.6.subMenus.1.name','menus.6.subMenus.1.route',
'menus.6.subMenus.1.icon','menus.6.subMenus.1.table','menus.6.subMenus.1.sidebar','menus.6.subMenus.2.roles','menus.6.subMenus.2.permissions',
'menus.6.subMenus.2.name','menus.6.subMenus.2.route','menus.6.subMenus.2.icon','menus.6.subMenus.2.table','menus.6.subMenus.2.sidebar',
'menus.6.subMenus.3.roles','menus.6.subMenus.3.permissions','menus.6.subMenus.3.name','menus.6.subMenus.3.route','menus.6.subMenus.3.icon',
'menus.6.subMenus.3.table','menus.6.subMenus.3.sidebar','menus.6.subMenus.4.roles','menus.6.subMenus.4.permissions','menus.6.subMenus.4.name',
'menus.6.subMenus.4.route','menus.6.subMenus.4.icon','menus.6.subMenus.4.table','menus.6.subMenus.4.sidebar','menus.6.subMenus.5.roles',
'menus.6.subMenus.5.permissions','menus.6.subMenus.5.name','menus.6.subMenus.5.route','menus.6.subMenus.5.icon','menus.6.subMenus.5.table',
'menus.6.subMenus.5.sidebar','permission.models.permission','permission.models.role','permission.table_names.roles','permission.table_names.permissions',
...
'cms.gallery.edit','cms.gallery.detail','cms.career.index','cms.career.add','cms.career.edit',
'cms.career.detail','cms.career-benefit.index','cms.career-benefit.add','cms.career-benefit.edit','cms.career-benefit.detail',
'cms.faq.index','cms.faq.add','cms.faq.edit','cms.faq.detail','cms.configuration.index',
...
'excel.faq','excel.gallery','excel.permission','excel.permission.role','excel.permission.user',
...
'livewire.cms.faq.edit','livewire.cms.faq.index','livewire.cms.forgot-password.index','livewire.cms.gallery.add','livewire.cms.gallery.detail',
...
'index.location_zh','index.career_benefit','index.f_a_q','index.index',);
