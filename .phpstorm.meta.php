...
'validation.attributes.answer_zh','validation.attributes.address','validation.attributes.maps','validation.attributes.index','validation.success',
...
'index.gallery_category','index.address','index.maps','index.index',);
