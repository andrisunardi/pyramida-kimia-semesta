...
'livewire.product.index','livewire::bootstrap','livewire::simple-bootstrap','livewire::simple-tailwind','livewire::tailwind',
...
'components::components.button.restore','components::components.button.upload','components::components.button.void','components::components.form.address','components::components.form.alert',
...
'components::components.form.date','components::components.form.description','components::components.form.email','components::components.form.enum','components::components.form.file',
...
'components::components.form.website','components::components.form.whatsapp','components::components.iframe','components::components.image','components::components.layouts.app',
...
'components::components.search.boolean','components::components.search.date','components::components.search.enum','components::components.search.icon','components::components.search.is-active',
...
'index.all','index.back_to_home','index.banner','index.category','index.change_language',
'index.chinese','index.company_profile','index.contact_us_if_you_have_any_questions','index.contact_us','index.contact',
'index.copyright','index.created_and_designed_by','index.data','index.email','index.english',
...
'index.warehouse','index.total','index.our_product','index.latest_article','index.read_more',
'index.partner','index.not_found','index.please_try_again_later','index.our_partner','index.call',);
