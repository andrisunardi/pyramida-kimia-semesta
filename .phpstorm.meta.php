...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'menus.11.subMenus.0.roles' => 'string',
            'menus.11.subMenus.0.permissions' => 'string',
            'menus.11.subMenus.0.name' => 'string',
            'menus.11.subMenus.0.route' => 'string',
            'menus.11.subMenus.0.icon' => 'string',
            'menus.11.subMenus.0.table' => 'NULL',
            'menus.11.subMenus.0.sidebar' => 'boolean',
            'menus.11.subMenus.1.roles' => 'string',
            'menus.11.subMenus.1.permissions' => 'string',
            'menus.11.subMenus.1.name' => 'string',
            'menus.11.subMenus.1.route' => 'string',
            'menus.11.subMenus.1.icon' => 'string',
            'menus.11.subMenus.1.table' => 'string',
            'menus.11.subMenus.1.sidebar' => 'boolean',
            'menus.11.subMenus.2.roles' => 'string',
            'menus.11.subMenus.2.permissions' => 'string',
            'menus.11.subMenus.2.name' => 'string',
            'menus.11.subMenus.2.route' => 'string',
            'menus.11.subMenus.2.icon' => 'string',
            'menus.11.subMenus.2.table' => 'string',
            'menus.11.subMenus.2.sidebar' => 'boolean',
            'menus.11.subMenus.3.roles' => 'string',
            'menus.11.subMenus.3.permissions' => 'string',
            'menus.11.subMenus.3.name' => 'string',
            'menus.11.subMenus.3.route' => 'string',
            'menus.11.subMenus.3.icon' => 'string',
            'menus.11.subMenus.3.table' => 'string',
            'menus.11.subMenus.3.sidebar' => 'boolean',
            'menus.11.subMenus.4.roles' => 'string',
            'menus.11.subMenus.4.permissions' => 'string',
            'menus.11.subMenus.4.name' => 'string',
            'menus.11.subMenus.4.route' => 'string',
            'menus.11.subMenus.4.icon' => 'string',
            'menus.11.subMenus.4.table' => 'string',
            'menus.11.subMenus.4.sidebar' => 'boolean',
            'menus.11.subMenus.5.roles' => 'string',
            'menus.11.subMenus.5.permissions' => 'string',
            'menus.11.subMenus.5.name' => 'string',
            'menus.11.subMenus.5.route' => 'string',
            'menus.11.subMenus.5.icon' => 'string',
            'menus.11.subMenus.5.table' => 'string',
            'menus.11.subMenus.5.sidebar' => 'boolean',
...
'menus.11.route','menus.11.icon','menus.11.table','menus.11.sidebar','menus.11.subMenus.0.roles',
'menus.11.subMenus.0.permissions','menus.11.subMenus.0.name','menus.11.subMenus.0.route','menus.11.subMenus.0.icon','menus.11.subMenus.0.table',
'menus.11.subMenus.0.sidebar','menus.11.subMenus.1.roles','menus.11.subMenus.1.permissions','menus.11.subMenus.1.name','menus.11.subMenus.1.route',
'menus.11.subMenus.1.icon','menus.11.subMenus.1.table','menus.11.subMenus.1.sidebar','menus.11.subMenus.2.roles','menus.11.subMenus.2.permissions',
'menus.11.subMenus.2.name','menus.11.subMenus.2.route','menus.11.subMenus.2.icon','menus.11.subMenus.2.table','menus.11.subMenus.2.sidebar',
'menus.11.subMenus.3.roles','menus.11.subMenus.3.permissions','menus.11.subMenus.3.name','menus.11.subMenus.3.route','menus.11.subMenus.3.icon',
'menus.11.subMenus.3.table','menus.11.subMenus.3.sidebar','menus.11.subMenus.4.roles','menus.11.subMenus.4.permissions','menus.11.subMenus.4.name',
'menus.11.subMenus.4.route','menus.11.subMenus.4.icon','menus.11.subMenus.4.table','menus.11.subMenus.4.sidebar','menus.11.subMenus.5.roles',
'menus.11.subMenus.5.permissions','menus.11.subMenus.5.name','menus.11.subMenus.5.route','menus.11.subMenus.5.icon','menus.11.subMenus.5.table',
'menus.11.subMenus.5.sidebar','permission.models.permission','permission.models.role','permission.table_names.roles','permission.table_names.permissions',
...
'permission.enable_wildcard_permission','permission.cache.expiration_time','permission.cache.key','permission.cache.store','permission.permission.wildcard_permission',
...
'tinker.dont_alias','hashing.driver','hashing.bcrypt.rounds','hashing.bcrypt.verify','hashing.argon.memory',
...
'cms.article.add','cms.article.edit','cms.article.detail','cms.product-category.index','cms.product-category.add',
'cms.product-category.edit','cms.product-category.detail','cms.gallery.index','cms.gallery.add','cms.gallery.edit',
'cms.gallery.detail','cms.gallery-category.index','cms.gallery-category.add','cms.gallery-category.edit','cms.gallery-category.detail',
'cms.partner.index','cms.partner.add','cms.partner.edit','cms.partner.detail','cms.history.index',
...
'excel.partner','excel.permission','excel.permission.role','excel.permission.user','excel.product-category',
'layouts.body','layouts.cms.body','layouts.cms.css','layouts.cms.script','layouts.cms.vendors',
'layouts.css','layouts.script','layouts.vendors','livewire-charts::livewire-area-chart','livewire-charts::livewire-column-chart',
...
'livewire-charts::livewire-radial-chart','livewire-charts::livewire-tree-map-chart','livewire.about.index','livewire.article.index','livewire.article.sidebar-right',
'livewire.article.view','livewire.banner','livewire.career.index','livewire.cms.article.add','livewire.cms.article.detail',
'livewire.cms.article.edit','livewire.cms.article.index','livewire.cms.career-benefit.add','livewire.cms.career-benefit.detail','livewire.cms.career-benefit.edit',
'livewire.cms.career-benefit.index','livewire.cms.career.add','livewire.cms.career.detail','livewire.cms.career.edit','livewire.cms.career.index',
'livewire.cms.configuration.permission.add','livewire.cms.configuration.permission.detail','livewire.cms.configuration.permission.edit','livewire.cms.configuration.permission.index','livewire.cms.configuration.permission.role',
'livewire.cms.configuration.permission.user','livewire.cms.contact.detail','livewire.cms.contact.index','livewire.cms.faq.add','livewire.cms.faq.detail',
'livewire.cms.faq.edit','livewire.cms.faq.index','livewire.cms.forgot-password.index','livewire.cms.gallery-category.add','livewire.cms.gallery-category.detail',
'livewire.cms.gallery-category.edit','livewire.cms.gallery-category.index','livewire.cms.gallery.add','livewire.cms.gallery.detail','livewire.cms.gallery.edit',
'livewire.cms.gallery.index','livewire.cms.history.add','livewire.cms.history.detail','livewire.cms.history.edit','livewire.cms.history.index',
'livewire.cms.home.index','livewire.cms.home.menu','livewire.cms.layouts.error','livewire.cms.layouts.footer','livewire.cms.layouts.header',
'livewire.cms.layouts.language','livewire.cms.layouts.profile','livewire.cms.layouts.search-menu','livewire.cms.layouts.server-time','livewire.cms.layouts.sidebar',
'livewire.cms.layouts.theme','livewire.cms.loader','livewire.cms.login.index','livewire.cms.office.add','livewire.cms.office.detail',
'livewire.cms.office.edit','livewire.cms.office.index','livewire.cms.partner.add','livewire.cms.partner.detail','livewire.cms.partner.edit',
'livewire.cms.partner.index','livewire.cms.product-category.add','livewire.cms.product-category.detail','livewire.cms.product-category.edit','livewire.cms.product-category.index',
...
'validation.attributes.answer_zh','validation.attributes.address','validation.attributes.maps','validation.attributes.gallery_category_id','validation.attributes.index',
'validation.success','index.#','index.about','index.action','index.active',
'index.activity_log','index.activity','index.add','index.all_right_reserved','index.all_rights_reserved',
...
'index.call','index.career','index.category','index.change_language','index.change_password',
'index.change','index.chinese','index.clone','index.company_profile','index.company',
'index.configuration','index.confirm_reset','index.confirm','index.contact_information','index.contact_us_if_you_have_any_questions',
'index.contact_us','index.contact','index.copyright','index.created_and_designed_by','index.created_at',
'index.created_by','index.created','index.current_password','index.dark','index.data',
'index.date','index.delete','index.description_id','index.description_zh','index.description',
'index.detail','index.download','index.edit_profile','index.edit','index.email',
'index.english','index.enquire','index.export_to_excel','index.export_to_pdf','index.failed',
'index.faq','index.featured_product','index.fields_has_been_successfully_reseted','index.find_opportunities','index.flag',
'index.forgot_password_failed','index.forgot_password_success','index.forgot_password','index.form_validation','index.format',
'index.frequently_asked_questions','index.gallery','index.get_in_touch','index.guard_name','index.has_been_successfully_added',
'index.has_been_successfully_changed','index.has_been_successfully_deleted','index.has_been_successfully_edited','index.has_been_successfully_exported','index.history',
'index.home','index.id','index.image','index.indonesia','index.last_activity',
'index.latest_article','index.learn_more','index.light','index.login_failed','index.login_has_been_successfully',
'index.login_success','index.login','index.logo','index.logout_failed','index.logout_success',
'index.logout','index.menu','index.message','index.my_profile','index.name_id',
'index.name_zh','index.name','index.new_password','index.new','index.next',
'index.no_data_available','index.no','index.not_found','index.office','index.old',
'index.other_articles','index.other_product','index.our_gallery','index.our_history','index.our_latest_product',
'index.our_mission','index.our_partner','index.our_product_category','index.our_product','index.our_team',
'index.our_vision','index.page_has_been_successfully_refreshed','index.partner','index.permission','index.phone',
'index.please_try_again_later','index.previous','index.printed_date','index.product_category','index.product',
'index.profile','index.quick_contact','index.quick_links','index.read_more','index.recent_articles',
'index.refresh','index.reserves','index.reset_filter','index.reset','index.resource',
'index.resources','index.role','index.roles_and_permissions','index.save','index.search',
'index.select','index.send_request','index.server_time','index.setting','index.size',
...
'index.your_message_has_been_received_successfully_we_appreciate_you_reaching_out_and_will_get_back_to_you_as_soon_as_possible','index.your_name','index.your_phone','index.your_profile_has_been_successfully_updated','index.example',
'index.link','index.location','index.location_id','index.location_zh','index.career_benefit',
'index.f_a_q','index.gallery_category','index.address','index.maps','index.index',);
