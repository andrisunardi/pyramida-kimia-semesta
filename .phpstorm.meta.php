...
'index.all','index.back_to_home','index.banner','index.call','index.category',
'index.change_language','index.chinese','index.company_profile','index.company','index.contact_us_if_you_have_any_questions',
'index.contact_us','index.contact','index.copyright','index.created_and_designed_by','index.data',
'index.download','index.email','index.english','index.faq','index.featured_product',
'index.frequently_asked_questions','index.form_validation','index.gallery','index.get_in_touch','index.home',
'index.indonesia','index.latest_article','index.article','index.learn_more','index.menu',
'index.next','index.not_found','index.office','index.our_gallery','index.our_latest_product',
...
'index.quick_links','index.read_more','index.submit','index.testimony','index.thank_you_for_contacting_us_we_will_reply_to_your_message_as_soon_as_possible',
'index.thank_you_for_contacting_us','index.total','index.view','index.warehouse','index.your_name',
'index.your_company','index.your_email','index.your_phone','index.write_subject','index.write_message',
'index.resource','index.resources','index.reserves','index.and','index.search',
'index.tags','index.contact_information','index.recent_articles','index.your_message_has_been_received_successfully_we_appreciate_you_reaching_out_and_will_get_back_to_you_as_soon_as_possible',);
