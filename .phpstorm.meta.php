...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'menus.15.table' => 'string',
            'menus.15.sidebar' => 'boolean',
            'menus.15.subMenus' => 'array',
            'menus.16.roles' => 'string',
            'menus.16.permissions' => 'string',
            'menus.16.name' => 'string',
            'menus.16.route' => 'string',
            'menus.16.icon' => 'string',
            'menus.16.table' => 'NULL',
            'menus.16.sidebar' => 'boolean',
            'menus.16.subMenus.0.roles' => 'string',
            'menus.16.subMenus.0.permissions' => 'string',
            'menus.16.subMenus.0.name' => 'string',
            'menus.16.subMenus.0.route' => 'string',
            'menus.16.subMenus.0.icon' => 'string',
            'menus.16.subMenus.0.table' => 'NULL',
            'menus.16.subMenus.0.sidebar' => 'boolean',
            'menus.16.subMenus.1.roles' => 'string',
            'menus.16.subMenus.1.permissions' => 'string',
            'menus.16.subMenus.1.name' => 'string',
            'menus.16.subMenus.1.route' => 'string',
            'menus.16.subMenus.1.icon' => 'string',
            'menus.16.subMenus.1.table' => 'string',
            'menus.16.subMenus.1.sidebar' => 'boolean',
            'menus.16.subMenus.2.roles' => 'string',
            'menus.16.subMenus.2.permissions' => 'string',
            'menus.16.subMenus.2.name' => 'string',
            'menus.16.subMenus.2.route' => 'string',
            'menus.16.subMenus.2.icon' => 'string',
            'menus.16.subMenus.2.table' => 'string',
            'menus.16.subMenus.2.sidebar' => 'boolean',
            'menus.16.subMenus.3.roles' => 'string',
            'menus.16.subMenus.3.permissions' => 'string',
            'menus.16.subMenus.3.name' => 'string',
            'menus.16.subMenus.3.route' => 'string',
            'menus.16.subMenus.3.icon' => 'string',
            'menus.16.subMenus.3.table' => 'string',
            'menus.16.subMenus.3.sidebar' => 'boolean',
            'menus.16.subMenus.4.roles' => 'string',
            'menus.16.subMenus.4.permissions' => 'string',
            'menus.16.subMenus.4.name' => 'string',
            'menus.16.subMenus.4.route' => 'string',
            'menus.16.subMenus.4.icon' => 'string',
            'menus.16.subMenus.4.table' => 'string',
            'menus.16.subMenus.4.sidebar' => 'boolean',
            'menus.16.subMenus.5.roles' => 'string',
            'menus.16.subMenus.5.permissions' => 'string',
            'menus.16.subMenus.5.name' => 'string',
            'menus.16.subMenus.5.route' => 'string',
            'menus.16.subMenus.5.icon' => 'string',
            'menus.16.subMenus.5.table' => 'string',
            'menus.16.subMenus.5.sidebar' => 'boolean',
...
'cors.allowed_headers','cors.exposed_headers','cors.max_age','cors.supports_credentials','activitylog.enabled',
...
'app.aliases.Validator','app.aliases.View','app.aliases.Vite','app.aliases.Excel','app.aliases.Menu',
'app.aliases.PDF','app.aliases.permission','app.aliases.QrCode','app.aliases.role_or_permission','app.aliases.role',
'app.aliases.Utils','app.roles','app.route_roles','app.cms_roles','app.route_cms_roles',
...
'database.connections.sqlsrv.encrypt','database.connections.sqlsrv.trust_server_certificate','database.connections.testing.driver','database.connections.testing.url','database.connections.testing.database',
'database.connections.testing.prefix','database.connections.testing.foreign_key_constraints','database.migrations.table','database.migrations.update_date_on_publish','database.redis.client',
...
'dompdf.options.font_height_ratio','dompdf.options.enable_html5_parser','dropbox.clientId','dropbox.clientSecret','dropbox.redirectUri',
'dropbox.landingUri','dropbox.accessToken','dropbox.accessType','dropbox.scopes','excel.exports.chunk_size',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.disks.azure.driver','filesystems.disks.azure.connection_string',
'filesystems.disks.azure.container','filesystems.disks.files.driver','filesystems.disks.files.root','filesystems.disks.files.url','filesystems.disks.files.visibility',
'filesystems.disks.images.driver','filesystems.disks.images.root','filesystems.disks.images.url','filesystems.disks.images.visibility','filesystems.disks.videos.driver',
'filesystems.disks.videos.root','filesystems.disks.videos.url','filesystems.disks.videos.visibility','filesystems.links./Users/andrisunardi/project/pyramida-kimia-semesta/public/storage','flare.key',
...
'flare.flare_middleware.Spatie\\FlareClient\\FlareMiddleware\\CensorRequestBodyFields.censor_fields','flare.flare_middleware.Spatie\\FlareClient\\FlareMiddleware\\CensorRequestHeaders.headers','flare.send_logs_as_events','horizon.domain','horizon.path',
...
'ide-helper.macroable_traits','ignition.editor','ignition.theme','ignition.enable_share_button','ignition.register_commands',
...
'livewire.navigate.progress_bar_color','livewire.inject_morph_markers','livewire.pagination_theme','livewire-alert.alert.position','livewire-alert.alert.timer',
'livewire-alert.alert.toast','livewire-alert.alert.showConfirmButton','livewire-alert.alert.timerProgressBar','livewire-alert.confirm.position','livewire-alert.confirm.icon',
'livewire-alert.confirm.toast','livewire-alert.confirm.timer','livewire-alert.confirm.showConfirmButton','livewire-alert.confirm.showCancelButton','livewire-alert.confirm.cancelButtonText',
'livewire-alert.confirm.confirmButtonColor','livewire-alert.confirm.cancelButtonColor','log-viewer.enabled','log-viewer.api_only','log-viewer.require_auth_in_production',
...
'mail.from.name','mail.markdown.theme','mail.markdown.paths','menus.0.roles','menus.0.permissions',
'menus.0.name','menus.0.route','menus.0.icon','menus.0.table','menus.0.sidebar',
'menus.0.subMenus','menus.1.roles','menus.1.permissions','menus.1.name','menus.1.route',
'menus.1.icon','menus.1.table','menus.1.sidebar','menus.1.subMenus','menus.2.roles',
'menus.2.permissions','menus.2.name','menus.2.route','menus.2.icon','menus.2.table',
'menus.2.sidebar','menus.2.subMenus','menus.3.roles','menus.3.permissions','menus.3.name',
'menus.3.route','menus.3.icon','menus.3.table','menus.3.sidebar','menus.3.subMenus',
'menus.4.roles','menus.4.permissions','menus.4.name','menus.4.route','menus.4.icon',
'menus.4.table','menus.4.sidebar','menus.4.subMenus','menus.5.roles','menus.5.permissions',
'menus.5.name','menus.5.route','menus.5.icon','menus.5.table','menus.5.sidebar',
'menus.5.subMenus','menus.6.roles','menus.6.permissions','menus.6.name','menus.6.route',
'menus.6.icon','menus.6.table','menus.6.sidebar','menus.6.subMenus','menus.7.roles',
'menus.7.permissions','menus.7.name','menus.7.route','menus.7.icon','menus.7.table',
'menus.7.sidebar','menus.7.subMenus','menus.8.roles','menus.8.permissions','menus.8.name',
'menus.8.route','menus.8.icon','menus.8.table','menus.8.sidebar','menus.8.subMenus',
'menus.9.roles','menus.9.permissions','menus.9.name','menus.9.route','menus.9.icon',
'menus.9.table','menus.9.sidebar','menus.9.subMenus','menus.10.roles','menus.10.permissions',
'menus.10.name','menus.10.route','menus.10.icon','menus.10.table','menus.10.sidebar',
'menus.10.subMenus','menus.11.roles','menus.11.permissions','menus.11.name','menus.11.route',
'menus.11.icon','menus.11.table','menus.11.sidebar','menus.11.subMenus','menus.12.roles',
'menus.12.permissions','menus.12.name','menus.12.route','menus.12.icon','menus.12.table',
'menus.12.sidebar','menus.12.subMenus','menus.13.roles','menus.13.permissions','menus.13.name',
'menus.13.route','menus.13.icon','menus.13.table','menus.13.sidebar','menus.13.subMenus',
'menus.14.roles','menus.14.permissions','menus.14.name','menus.14.route','menus.14.icon',
'menus.14.table','menus.14.sidebar','menus.14.subMenus','menus.15.roles','menus.15.permissions',
'menus.15.name','menus.15.route','menus.15.icon','menus.15.table','menus.15.sidebar',
'menus.15.subMenus','menus.16.roles','menus.16.permissions','menus.16.name','menus.16.route',
'menus.16.icon','menus.16.table','menus.16.sidebar','menus.16.subMenus.0.roles','menus.16.subMenus.0.permissions',
'menus.16.subMenus.0.name','menus.16.subMenus.0.route','menus.16.subMenus.0.icon','menus.16.subMenus.0.table','menus.16.subMenus.0.sidebar',
'menus.16.subMenus.1.roles','menus.16.subMenus.1.permissions','menus.16.subMenus.1.name','menus.16.subMenus.1.route','menus.16.subMenus.1.icon',
'menus.16.subMenus.1.table','menus.16.subMenus.1.sidebar','menus.16.subMenus.2.roles','menus.16.subMenus.2.permissions','menus.16.subMenus.2.name',
'menus.16.subMenus.2.route','menus.16.subMenus.2.icon','menus.16.subMenus.2.table','menus.16.subMenus.2.sidebar','menus.16.subMenus.3.roles',
'menus.16.subMenus.3.permissions','menus.16.subMenus.3.name','menus.16.subMenus.3.route','menus.16.subMenus.3.icon','menus.16.subMenus.3.table',
'menus.16.subMenus.3.sidebar','menus.16.subMenus.4.roles','menus.16.subMenus.4.permissions','menus.16.subMenus.4.name','menus.16.subMenus.4.route',
'menus.16.subMenus.4.icon','menus.16.subMenus.4.table','menus.16.subMenus.4.sidebar','menus.16.subMenus.5.roles','menus.16.subMenus.5.permissions',
'menus.16.subMenus.5.name','menus.16.subMenus.5.route','menus.16.subMenus.5.icon','menus.16.subMenus.5.table','menus.16.subMenus.5.sidebar',
...
'permission.cache.expiration_time','permission.cache.key','permission.cache.store','permission.permission.wildcard_permission','pretty-routes.url',
...
'cms.gallery-category.index','cms.gallery-category.add','cms.gallery-category.edit','cms.gallery-category.detail','cms.event.index',
'cms.event.add','cms.event.edit','cms.event.detail','cms.slider.index','cms.slider.add',
'cms.slider.edit','cms.slider.detail','cms.testimony.index','cms.testimony.add','cms.testimony.edit',
'cms.testimony.detail','cms.partner.index','cms.partner.add','cms.partner.edit','cms.partner.detail',
'cms.team.index','cms.team.add','cms.team.edit','cms.team.detail','cms.history.index',
'cms.history.add','cms.history.edit','cms.history.detail','cms.career.index','cms.career.add',
'cms.career.edit','cms.career.detail','cms.career-benefit.index','cms.career-benefit.add','cms.career-benefit.edit',
'cms.career-benefit.detail','cms.faq.index','cms.faq.add','cms.faq.edit','cms.faq.detail',
'cms.office.index','cms.office.add','cms.office.edit','cms.office.detail','cms.configuration.index',
'cms.configuration.activity','cms.configuration.user.index','cms.configuration.user.add','cms.configuration.user.edit','cms.configuration.user.delete',
'cms.configuration.user.detail','cms.configuration.role.index','cms.configuration.role.add','cms.configuration.role.edit','cms.configuration.role.delete',
'cms.configuration.role.detail','cms.configuration.permission.index','cms.configuration.permission.add','cms.configuration.permission.edit','cms.configuration.permission.detail',
'cms.configuration.setting.index','cms.configuration.setting.add','cms.configuration.setting.edit','cms.configuration.setting.delete','cms.configuration.setting.detail',
'cms.profile.index','cms.profile.activity-log','cms.profile.edit-profile','cms.profile.change-password','cms.logout',
'storage.local',);
...
'excel.event','excel.faq','excel.gallery','excel.gallery-category','excel.history',
'excel.office','excel.partner','excel.permission','excel.product','excel.product-category',
'excel.role','excel.slider','excel.team','excel.testimony','layouts.body',
...
'livewire.cms.contact.detail','livewire.cms.contact.index','livewire.cms.event.add','livewire.cms.event.detail','livewire.cms.event.edit',
'livewire.cms.event.index','livewire.cms.faq.add','livewire.cms.faq.detail','livewire.cms.faq.edit','livewire.cms.faq.index',
...
'livewire.home.article','livewire.home.event','livewire.home.index','livewire.home.partner','livewire.home.product',
...
'validation.uuid','validation.custom.attribute-name.rule-name','index.#','index.about','index.action',
'index.active','index.activity_log','index.activity','index.add','index.address',
'index.all_right_reserved','index.all_rights_reserved','index.all','index.and','index.apply_online',
'index.article','index.attributes','index.auto','index.back_to_home','index.back_to_login',
'index.back','index.banner','index.call','index.career_benefit','index.career',
'index.category','index.change_language','index.change_password','index.change','index.chinese',
'index.clone','index.company_profile','index.company','index.configuration','index.confirm_reset',
'index.confirm','index.contact_information','index.contact_us_if_you_have_any_questions','index.contact_us','index.contact',
'index.copyright','index.created_and_designed_by','index.created_at','index.created_by','index.created',
'index.current_password','index.dark','index.data','index.date','index.delete',
'index.description_id','index.description_zh','index.description','index.detail','index.download',
'index.edit_profile','index.edit','index.email','index.english','index.enquire',
'index.example','index.export_to_excel','index.export_to_pdf','index.f_a_q','index.failed',
'index.faq','index.featured_product','index.fields_has_been_successfully_reseted','index.file_coa','index.file_msds',
'index.find_opportunities','index.flag','index.forgot_password_failed','index.forgot_password_success','index.forgot_password',
'index.form_validation','index.format','index.frequently_asked_questions','index.gallery_category','index.gallery',
'index.get_in_touch','index.guard_name','index.has_been_successfully_added','index.has_been_successfully_changed','index.has_been_successfully_deleted',
'index.has_been_successfully_edited','index.has_been_successfully_exported','index.history','index.home','index.id',
'index.image','index.indonesia','index.job','index.last_activity','index.latest_article',
'index.learn_more','index.light','index.link','index.location_id','index.location_zh',
'index.location','index.login_failed','index.login_has_been_successfully','index.login_success','index.login',
'index.logo','index.logout_failed','index.logout_success','index.logout','index.maps',
...
'index.send_request','index.server_time','index.setting','index.size','index.slider',
'index.slug','index.stay_login','index.subject','index.submit','index.success',
'index.tags_id','index.tags_zh','index.tags','index.team','index.testimony',
'index.thank_you_for_contacting_us_we_will_reply_to_your_message_as_soon_as_possible','index.thank_you_for_contacting_us','index.theme','index.total','index.trash',
'index.updated_at','index.updated_by','index.updated','index.user','index.username_or_password_is_invalid',
'index.username','index.view','index.vision_and_mission','index.warehouse','index.write_message',
'index.write_subject','index.yes','index.you_have_been_successfully_logged_out','index.your_company','index.your_email',
'index.your_message_has_been_received_successfully_we_appreciate_you_reaching_out_and_will_get_back_to_you_as_soon_as_possible','index.your_name','index.your_phone','index.your_profile_has_been_successfully_updated','index.your_profile',
'index.your_password','index.whatsapp','index.event','index.please_wait_until_the_uploading_finished','index.video',
'index.index','validation.success','validation.attributes.address','validation.attributes.answer_id','validation.attributes.answer_zh',
...
'validation.attributes.url','validation.attributes.user','validation.attributes.username','validation.attributes.video','validation.attributes.index',);
