...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'menus.4.subMenus.0.roles' => 'string',
            'menus.4.subMenus.0.permissions' => 'string',
            'menus.4.subMenus.0.name' => 'string',
            'menus.4.subMenus.0.route' => 'string',
            'menus.4.subMenus.0.icon' => 'string',
            'menus.4.subMenus.0.table' => 'NULL',
            'menus.4.subMenus.0.sidebar' => 'boolean',
            'menus.4.subMenus.1.roles' => 'string',
            'menus.4.subMenus.1.permissions' => 'string',
            'menus.4.subMenus.1.name' => 'string',
            'menus.4.subMenus.1.route' => 'string',
            'menus.4.subMenus.1.icon' => 'string',
            'menus.4.subMenus.1.table' => 'string',
            'menus.4.subMenus.1.sidebar' => 'boolean',
            'menus.4.subMenus.2.roles' => 'string',
            'menus.4.subMenus.2.permissions' => 'string',
            'menus.4.subMenus.2.name' => 'string',
            'menus.4.subMenus.2.route' => 'string',
            'menus.4.subMenus.2.icon' => 'string',
            'menus.4.subMenus.2.table' => 'string',
            'menus.4.subMenus.2.sidebar' => 'boolean',
            'menus.4.subMenus.3.roles' => 'string',
            'menus.4.subMenus.3.permissions' => 'string',
            'menus.4.subMenus.3.name' => 'string',
            'menus.4.subMenus.3.route' => 'string',
            'menus.4.subMenus.3.icon' => 'string',
            'menus.4.subMenus.3.table' => 'string',
            'menus.4.subMenus.3.sidebar' => 'boolean',
            'menus.4.subMenus.4.roles' => 'string',
            'menus.4.subMenus.4.permissions' => 'string',
            'menus.4.subMenus.4.name' => 'string',
            'menus.4.subMenus.4.route' => 'string',
            'menus.4.subMenus.4.icon' => 'string',
            'menus.4.subMenus.4.table' => 'string',
            'menus.4.subMenus.4.sidebar' => 'boolean',
            'menus.4.subMenus.5.roles' => 'string',
            'menus.4.subMenus.5.permissions' => 'string',
            'menus.4.subMenus.5.name' => 'string',
            'menus.4.subMenus.5.route' => 'string',
            'menus.4.subMenus.5.icon' => 'string',
            'menus.4.subMenus.5.table' => 'string',
            'menus.4.subMenus.5.sidebar' => 'boolean',
...
'menus.4.icon','menus.4.table','menus.4.sidebar','menus.4.subMenus.0.roles','menus.4.subMenus.0.permissions',
'menus.4.subMenus.0.name','menus.4.subMenus.0.route','menus.4.subMenus.0.icon','menus.4.subMenus.0.table','menus.4.subMenus.0.sidebar',
'menus.4.subMenus.1.roles','menus.4.subMenus.1.permissions','menus.4.subMenus.1.name','menus.4.subMenus.1.route','menus.4.subMenus.1.icon',
'menus.4.subMenus.1.table','menus.4.subMenus.1.sidebar','menus.4.subMenus.2.roles','menus.4.subMenus.2.permissions','menus.4.subMenus.2.name',
'menus.4.subMenus.2.route','menus.4.subMenus.2.icon','menus.4.subMenus.2.table','menus.4.subMenus.2.sidebar','menus.4.subMenus.3.roles',
'menus.4.subMenus.3.permissions','menus.4.subMenus.3.name','menus.4.subMenus.3.route','menus.4.subMenus.3.icon','menus.4.subMenus.3.table',
'menus.4.subMenus.3.sidebar','menus.4.subMenus.4.roles','menus.4.subMenus.4.permissions','menus.4.subMenus.4.name','menus.4.subMenus.4.route',
'menus.4.subMenus.4.icon','menus.4.subMenus.4.table','menus.4.subMenus.4.sidebar','menus.4.subMenus.5.roles','menus.4.subMenus.5.permissions',
'menus.4.subMenus.5.name','menus.4.subMenus.5.route','menus.4.subMenus.5.icon','menus.4.subMenus.5.table','menus.4.subMenus.5.sidebar',
...
'cms.career-benefit.detail','cms.configuration.index','cms.configuration.activity','cms.configuration.user.index','cms.configuration.user.add',
...
'livewire.cms.contact.index','livewire.cms.forgot-password.index','livewire.cms.home.index','livewire.cms.home.menu','livewire.cms.layouts.error',
...
'validation.attributes.index','validation.success','index.#','index.about','index.action',
'index.active','index.activity_log','index.activity','index.add','index.all_right_reserved',
'index.all_rights_reserved','index.all','index.and','index.apply_online','index.article',
'index.attributes','index.auto','index.back_to_home','index.back_to_login','index.back',
'index.banner','index.call','index.career','index.category','index.change_language',
...
'index.email','index.english','index.enquire','index.export_to_excel','index.export_to_pdf',
'index.failed','index.faq','index.featured_product','index.fields_has_been_successfully_reseted','index.find_opportunities',
'index.flag','index.forgot_password_failed','index.forgot_password_success','index.forgot_password','index.form_validation',
'index.format','index.frequently_asked_questions','index.gallery','index.get_in_touch','index.guard_name',
...
'index.last_activity','index.latest_article','index.learn_more','index.light','index.login_failed',
'index.login_has_been_successfully','index.login_success','index.login','index.logo','index.logout_failed',
'index.logout_success','index.logout','index.menu','index.message','index.my_profile',
'index.name_id','index.name_zh','index.name','index.new_password','index.new',
'index.next','index.no_data_available','index.no','index.not_found','index.office',
'index.old','index.other_articles','index.other_product','index.our_gallery','index.our_history',
'index.our_latest_product','index.our_mission','index.our_partner','index.our_product_category','index.our_product',
'index.our_team','index.our_vision','index.page_has_been_successfully_refreshed','index.partner','index.permission',
'index.phone','index.please_try_again_later','index.previous','index.printed_date','index.product_category',
'index.product','index.profile','index.quick_contact','index.quick_links','index.read_more',
'index.recent_articles','index.refresh','index.reserves','index.reset_filter','index.reset',
'index.resource','index.resources','index.role','index.roles_and_permissions','index.save',
'index.search','index.select','index.send_request','index.server_time','index.setting',
'index.size','index.slug','index.stay_login','index.subject','index.submit',
'index.success','index.tags_id','index.tags_zh','index.tags','index.team',
'index.testimony','index.thank_you_for_contacting_us_we_will_reply_to_your_message_as_soon_as_possible','index.thank_you_for_contacting_us','index.theme','index.total',
'index.trash','index.updated_at','index.updated_by','index.updated','index.user',
...
'index.example','index.link','index.location','index.location_id','index.location_zh',
'index.career_benefit','index.index',);
