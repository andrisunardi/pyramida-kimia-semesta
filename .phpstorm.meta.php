...
'index.your_email','index.your_phone','index.write_subject','index.write_message','index.resource',
'index.resources','index.reserves','index.and','index.your_message_has_been_received_successfully_we_appreciate_you_reaching_out_and_will_get_back_to_you_as_soon_as_possible',);
