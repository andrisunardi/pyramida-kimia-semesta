...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'menus.8.subMenus.0.roles' => 'string',
            'menus.8.subMenus.0.permissions' => 'string',
            'menus.8.subMenus.0.name' => 'string',
            'menus.8.subMenus.0.route' => 'string',
            'menus.8.subMenus.0.icon' => 'string',
            'menus.8.subMenus.0.table' => 'NULL',
            'menus.8.subMenus.0.sidebar' => 'boolean',
            'menus.8.subMenus.1.roles' => 'string',
            'menus.8.subMenus.1.permissions' => 'string',
            'menus.8.subMenus.1.name' => 'string',
            'menus.8.subMenus.1.route' => 'string',
            'menus.8.subMenus.1.icon' => 'string',
            'menus.8.subMenus.1.table' => 'string',
            'menus.8.subMenus.1.sidebar' => 'boolean',
            'menus.8.subMenus.2.roles' => 'string',
            'menus.8.subMenus.2.permissions' => 'string',
            'menus.8.subMenus.2.name' => 'string',
            'menus.8.subMenus.2.route' => 'string',
            'menus.8.subMenus.2.icon' => 'string',
            'menus.8.subMenus.2.table' => 'string',
            'menus.8.subMenus.2.sidebar' => 'boolean',
            'menus.8.subMenus.3.roles' => 'string',
            'menus.8.subMenus.3.permissions' => 'string',
            'menus.8.subMenus.3.name' => 'string',
            'menus.8.subMenus.3.route' => 'string',
            'menus.8.subMenus.3.icon' => 'string',
            'menus.8.subMenus.3.table' => 'string',
            'menus.8.subMenus.3.sidebar' => 'boolean',
            'menus.8.subMenus.4.roles' => 'string',
            'menus.8.subMenus.4.permissions' => 'string',
            'menus.8.subMenus.4.name' => 'string',
            'menus.8.subMenus.4.route' => 'string',
            'menus.8.subMenus.4.icon' => 'string',
            'menus.8.subMenus.4.table' => 'string',
            'menus.8.subMenus.4.sidebar' => 'boolean',
            'menus.8.subMenus.5.roles' => 'string',
            'menus.8.subMenus.5.permissions' => 'string',
            'menus.8.subMenus.5.name' => 'string',
            'menus.8.subMenus.5.route' => 'string',
            'menus.8.subMenus.5.icon' => 'string',
            'menus.8.subMenus.5.table' => 'string',
            'menus.8.subMenus.5.sidebar' => 'boolean',
...
'menus.8.subMenus.0.roles','menus.8.subMenus.0.permissions','menus.8.subMenus.0.name','menus.8.subMenus.0.route','menus.8.subMenus.0.icon',
'menus.8.subMenus.0.table','menus.8.subMenus.0.sidebar','menus.8.subMenus.1.roles','menus.8.subMenus.1.permissions','menus.8.subMenus.1.name',
'menus.8.subMenus.1.route','menus.8.subMenus.1.icon','menus.8.subMenus.1.table','menus.8.subMenus.1.sidebar','menus.8.subMenus.2.roles',
'menus.8.subMenus.2.permissions','menus.8.subMenus.2.name','menus.8.subMenus.2.route','menus.8.subMenus.2.icon','menus.8.subMenus.2.table',
'menus.8.subMenus.2.sidebar','menus.8.subMenus.3.roles','menus.8.subMenus.3.permissions','menus.8.subMenus.3.name','menus.8.subMenus.3.route',
'menus.8.subMenus.3.icon','menus.8.subMenus.3.table','menus.8.subMenus.3.sidebar','menus.8.subMenus.4.roles','menus.8.subMenus.4.permissions',
'menus.8.subMenus.4.name','menus.8.subMenus.4.route','menus.8.subMenus.4.icon','menus.8.subMenus.4.table','menus.8.subMenus.4.sidebar',
'menus.8.subMenus.5.roles','menus.8.subMenus.5.permissions','menus.8.subMenus.5.name','menus.8.subMenus.5.route','menus.8.subMenus.5.icon',
'menus.8.subMenus.5.table','menus.8.subMenus.5.sidebar','permission.models.permission','permission.models.role','permission.table_names.roles',
...
'cms.faq.edit','cms.faq.detail','cms.configuration.index','cms.configuration.activity','cms.configuration.user.index',
...
'excel.faq','excel.gallery','excel.gallery-category','excel.history','excel.permission',
'excel.permission.role','excel.permission.user','layouts.body','layouts.cms.body','layouts.cms.css',
...
'validation.attributes.answer_zh','validation.attributes.index','validation.success','index.#','index.about',
'index.action','index.active','index.activity_log','index.activity','index.add',
...
'index.back','index.banner','index.call','index.career','index.category',
'index.change_language','index.change_password','index.change','index.chinese','index.clone',
'index.company_profile','index.company','index.configuration','index.confirm_reset','index.confirm',
'index.contact_information','index.contact_us_if_you_have_any_questions','index.contact_us','index.contact','index.copyright',
'index.created_and_designed_by','index.created_at','index.created_by','index.created','index.current_password',
'index.dark','index.data','index.date','index.delete','index.description_id',
'index.description_zh','index.description','index.detail','index.download','index.edit_profile',
'index.edit','index.email','index.english','index.enquire','index.export_to_excel',
'index.export_to_pdf','index.failed','index.faq','index.featured_product','index.fields_has_been_successfully_reseted',
'index.find_opportunities','index.flag','index.forgot_password_failed','index.forgot_password_success','index.forgot_password',
'index.form_validation','index.format','index.frequently_asked_questions','index.gallery','index.get_in_touch',
'index.guard_name','index.has_been_successfully_added','index.has_been_successfully_changed','index.has_been_successfully_deleted','index.has_been_successfully_edited',
'index.has_been_successfully_exported','index.history','index.home','index.id','index.image',
'index.indonesia','index.last_activity','index.latest_article','index.learn_more','index.light',
'index.login_failed','index.login_has_been_successfully','index.login_success','index.login','index.logo',
'index.logout_failed','index.logout_success','index.logout','index.menu','index.message',
...
'index.setting','index.size','index.slug','index.stay_login','index.subject',
'index.submit','index.success','index.tags_id','index.tags_zh','index.tags',
'index.team','index.testimony','index.thank_you_for_contacting_us_we_will_reply_to_your_message_as_soon_as_possible','index.thank_you_for_contacting_us','index.theme',
'index.total','index.trash','index.updated_at','index.updated_by','index.updated',
'index.user','index.username_or_password_is_invalid','index.username','index.view','index.vision_and_mission',
'index.warehouse','index.write_message','index.write_subject','index.yes','index.you_have_been_successfully_logged_out',
'index.your_company','index.your_email','index.your_message_has_been_received_successfully_we_appreciate_you_reaching_out_and_will_get_back_to_you_as_soon_as_possible','index.your_name','index.your_phone',
'index.your_profile_has_been_successfully_updated','index.example','index.link','index.location','index.location_id',
'index.location_zh','index.career_benefit','index.f_a_q','index.gallery_category','index.index',);
