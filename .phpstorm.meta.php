...
'validation.attributes.message','validation.attributes.is_active','validation.attributes.search','validation.attributes.data','validation.success',
'index.about','index.all_right_reserved','index.all_rights_reserved','index.all','index.and',
'index.article','index.back_to_home','index.banner','index.call','index.category',
'index.change_language','index.chinese','index.company_profile','index.company','index.contact_information',
'index.contact_us_if_you_have_any_questions','index.contact_us','index.contact','index.copyright','index.created_and_designed_by',
'index.data','index.download','index.email','index.english','index.enquire',
'index.faq','index.featured_product','index.form_validation','index.frequently_asked_questions','index.gallery',
'index.get_in_touch','index.history','index.home','index.indonesia','index.latest_article',
'index.learn_more','index.menu','index.message','index.name','index.next',
'index.not_found','index.office','index.other_articles','index.our_gallery','index.our_history',
'index.our_latest_product','index.our_partner','index.our_product_category','index.our_product','index.partner',
'index.phone','index.please_try_again_later','index.previous','index.product_category','index.product',
'index.quick_contact','index.quick_links','index.read_more','index.recent_articles','index.reserves',
'index.resource','index.resources','index.search','index.subject','index.submit',
'index.tags','index.testimony','index.thank_you_for_contacting_us_we_will_reply_to_your_message_as_soon_as_possible','index.thank_you_for_contacting_us','index.total',
'index.view','index.warehouse','index.write_message','index.write_subject','index.your_company',
'index.your_email','index.your_message_has_been_received_successfully_we_appreciate_you_reaching_out_and_will_get_back_to_you_as_soon_as_possible','index.your_name','index.your_phone','index.career',
'index.find_opportunities','index.apply_online','index.our_team','index.team','index.vision_and_mission',
'index.our_vision','index.our_mission','index.other_product','index.login','index.login_failed',
'index.username_or_password_is_invalid','index.stay_login','index.forgot_password','index.confirm_reset','index.back_to_login',
'index.send_request','index.login_success','index.forgot_password_success','index.forgot_password_failed','index.current_password',
'index.new_password','index.server_time','index.theme','index.flag','index.light',
'index.dark','index.auto','index.profile','index.activity_log','index.edit_profile',
'index.change_password','index.logout','index.logout_failed','index.logout_success','index.you_have_been_successfully_logged_out',
'index.role','index.username','index.active','index.created_by','index.updated_by',
'index.created_at','index.updated_at','index.last_activity','index.created','index.updated',
'index.attributes','index.roles_and_permissions','index.logo','index.user','index.my_profile',
