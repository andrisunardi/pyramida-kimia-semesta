...
'validation.attributes.new_password','validation.attributes.confirm_password','validation.attributes.data','validation.success','index.about',
'index.all_right_reserved','index.all_rights_reserved','index.all','index.and','index.article',
'index.back_to_home','index.banner','index.call','index.category','index.change_language',
'index.chinese','index.company_profile','index.company','index.contact_information','index.contact_us_if_you_have_any_questions',
'index.contact_us','index.contact','index.copyright','index.created_and_designed_by','index.data',
'index.download','index.email','index.english','index.enquire','index.faq',
'index.featured_product','index.form_validation','index.frequently_asked_questions','index.gallery','index.get_in_touch',
'index.history','index.home','index.indonesia','index.latest_article','index.learn_more',
'index.menu','index.message','index.name','index.next','index.not_found',
'index.office','index.other_articles','index.our_gallery','index.our_history','index.our_latest_product',
'index.our_partner','index.our_product_category','index.our_product','index.partner','index.phone',
'index.please_try_again_later','index.previous','index.product_category','index.product','index.quick_contact',
'index.quick_links','index.read_more','index.recent_articles','index.reserves','index.resource',
'index.resources','index.search','index.subject','index.submit','index.tags',
'index.testimony','index.thank_you_for_contacting_us_we_will_reply_to_your_message_as_soon_as_possible','index.thank_you_for_contacting_us','index.total','index.view',
...
'index.stay_login','index.forgot_password','index.confirm_reset','index.back_to_login','index.send_request',
'index.login_success','index.forgot_password_success','index.forgot_password_failed','index.current_password','index.new_password',
'index.server_time','index.theme','index.flag','index.light','index.dark',
'index.auto','index.profile','index.activity_log','index.edit_profile','index.change_password',
'index.logout','index.logout_failed','index.logout_success','index.you_have_been_successfully_logged_out','index.role',
'index.username','index.active','index.created_by','index.updated_by','index.created_at',
'index.updated_at','index.last_activity','index.created','index.updated','index.attributes',
'index.roles_and_permissions','index.logo','index.user','index.my_profile','index.yes',
'index.no','index.reset_filter','index.trash','index.#','index.id',
'index.action','index.add','index.edit','index.delete','index.clone',
'index.login_has_been_successfully','index.no_data_available','index.refresh','index.page_has_been_successfully_refreshed','index.success',
'index.failed','index.fields_has_been_successfully_reseted','index.back','index.reset','index.old',
'index.new','index.your_profile_has_been_successfully_updated','index.image','index.format','index.size',);
