...
'components.layouts.meta','emails.contact','emails.database-backup-daily','errors.400','errors.401',
...
'errors.layout','errors.maintenance','errors.minimal','layouts.body','layouts.cms.body',
...
'livewire.about.index','livewire.contact.index','livewire.faq.index','livewire.gallery.index','livewire.home.index',
...
'index.quick_links','index.submit','index.thank_you_for_contacting_us_we_will_reply_to_your_message_as_soon_as_possible','index.view',);
