...
'validation.uuid','validation.custom.attribute-name.rule-name','validation.attributes.address','validation.attributes.answer_id','validation.attributes.answer_zh',
'validation.attributes.answer','validation.attributes.company','validation.attributes.confirm_password','validation.attributes.confirm_reset','validation.attributes.current_password',
'validation.attributes.date','validation.attributes.description_id','validation.attributes.description_zh','validation.attributes.description','validation.attributes.email',
'validation.attributes.file_coa','validation.attributes.file_msds','validation.attributes.gallery_category_id','validation.attributes.guard_name','validation.attributes.image',
'validation.attributes.is_active','validation.attributes.job','validation.attributes.link','validation.attributes.location_id','validation.attributes.location_zh',
'validation.attributes.location','validation.attributes.maps','validation.attributes.message','validation.attributes.name_id','validation.attributes.name_zh',
'validation.attributes.name','validation.attributes.new_password','validation.attributes.password','validation.attributes.phone','validation.attributes.product_category_id',
'validation.attributes.question_id','validation.attributes.question_zh','validation.attributes.question','validation.attributes.role','validation.attributes.search',
'validation.attributes.slug','validation.attributes.subject','validation.attributes.tags_id','validation.attributes.tags_zh','validation.attributes.tags',
'validation.attributes.url','validation.attributes.user','validation.attributes.username','validation.attributes.index','validation.success',
'index.#','index.about','index.action','index.active','index.activity_log',
'index.activity','index.add','index.address','index.all_right_reserved','index.all_rights_reserved',
'index.all','index.and','index.apply_online','index.article','index.attributes',
'index.auto','index.back_to_home','index.back_to_login','index.back','index.banner',
'index.call','index.career_benefit','index.career','index.category','index.change_language',
'index.change_password','index.change','index.chinese','index.clone','index.company_profile',
'index.company','index.configuration','index.confirm_reset','index.confirm','index.contact_information',
'index.contact_us_if_you_have_any_questions','index.contact_us','index.contact','index.copyright','index.created_and_designed_by',
'index.created_at','index.created_by','index.created','index.current_password','index.dark',
'index.data','index.date','index.delete','index.description_id','index.description_zh',
'index.description','index.detail','index.download','index.edit_profile','index.edit',
'index.email','index.english','index.enquire','index.example','index.export_to_excel',
'index.export_to_pdf','index.f_a_q','index.failed','index.faq','index.featured_product',
'index.fields_has_been_successfully_reseted','index.file_coa','index.file_msds','index.find_opportunities','index.flag',
'index.forgot_password_failed','index.forgot_password_success','index.forgot_password','index.form_validation','index.format',
'index.frequently_asked_questions','index.gallery_category','index.gallery','index.get_in_touch','index.guard_name',
'index.has_been_successfully_added','index.has_been_successfully_changed','index.has_been_successfully_deleted','index.has_been_successfully_edited','index.has_been_successfully_exported',
'index.history','index.home','index.id','index.image','index.indonesia',
'index.job','index.last_activity','index.latest_article','index.learn_more','index.light',
'index.link','index.location_id','index.location_zh','index.location','index.login_failed',
'index.login_has_been_successfully','index.login_success','index.login','index.logo','index.logout_failed',
'index.logout_success','index.logout','index.maps','index.menu','index.message',
'index.my_profile','index.name_id','index.name_zh','index.name','index.new_password',
'index.new','index.next','index.no_data_available','index.no','index.not_found',
'index.office','index.old','index.other_articles','index.other_product','index.our_gallery',
'index.our_history','index.our_latest_product','index.our_mission','index.our_partner','index.our_product_category',
'index.our_product','index.our_team','index.our_vision','index.page_has_been_successfully_refreshed','index.partner',
'index.permission','index.phone','index.please_try_again_later','index.previous','index.printed_date',
'index.product_category','index.product','index.profile','index.quick_contact','index.quick_links',
'index.read_more','index.recent_articles','index.refresh','index.reserves','index.reset_filter',
'index.reset','index.resource','index.resources','index.role','index.roles_and_permissions',
'index.save','index.search','index.select','index.send_request','index.server_time',
'index.setting','index.size','index.slider','index.slug','index.stay_login',
'index.subject','index.submit','index.success','index.tags_id','index.tags_zh',
'index.tags','index.team','index.testimony','index.thank_you_for_contacting_us_we_will_reply_to_your_message_as_soon_as_possible','index.thank_you_for_contacting_us',
'index.theme','index.total','index.trash','index.updated_at','index.updated_by',
'index.updated','index.user','index.username_or_password_is_invalid','index.username','index.view',
'index.vision_and_mission','index.warehouse','index.write_message','index.write_subject','index.yes',
'index.you_have_been_successfully_logged_out','index.your_company','index.your_email','index.your_message_has_been_received_successfully_we_appreciate_you_reaching_out_and_will_get_back_to_you_as_soon_as_possible','index.your_name',
'index.your_phone','index.your_profile_has_been_successfully_updated','index.index',);
