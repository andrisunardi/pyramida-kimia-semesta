...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'menus.13.subMenus.0.roles' => 'string',
            'menus.13.subMenus.0.permissions' => 'string',
            'menus.13.subMenus.0.name' => 'string',
            'menus.13.subMenus.0.route' => 'string',
            'menus.13.subMenus.0.icon' => 'string',
            'menus.13.subMenus.0.table' => 'NULL',
            'menus.13.subMenus.0.sidebar' => 'boolean',
            'menus.13.subMenus.1.roles' => 'string',
            'menus.13.subMenus.1.permissions' => 'string',
            'menus.13.subMenus.1.name' => 'string',
            'menus.13.subMenus.1.route' => 'string',
            'menus.13.subMenus.1.icon' => 'string',
            'menus.13.subMenus.1.table' => 'string',
            'menus.13.subMenus.1.sidebar' => 'boolean',
            'menus.13.subMenus.2.roles' => 'string',
            'menus.13.subMenus.2.permissions' => 'string',
            'menus.13.subMenus.2.name' => 'string',
            'menus.13.subMenus.2.route' => 'string',
            'menus.13.subMenus.2.icon' => 'string',
            'menus.13.subMenus.2.table' => 'string',
            'menus.13.subMenus.2.sidebar' => 'boolean',
            'menus.13.subMenus.3.roles' => 'string',
            'menus.13.subMenus.3.permissions' => 'string',
            'menus.13.subMenus.3.name' => 'string',
            'menus.13.subMenus.3.route' => 'string',
            'menus.13.subMenus.3.icon' => 'string',
            'menus.13.subMenus.3.table' => 'string',
            'menus.13.subMenus.3.sidebar' => 'boolean',
            'menus.13.subMenus.4.roles' => 'string',
            'menus.13.subMenus.4.permissions' => 'string',
            'menus.13.subMenus.4.name' => 'string',
            'menus.13.subMenus.4.route' => 'string',
            'menus.13.subMenus.4.icon' => 'string',
            'menus.13.subMenus.4.table' => 'string',
            'menus.13.subMenus.4.sidebar' => 'boolean',
            'menus.13.subMenus.5.roles' => 'string',
            'menus.13.subMenus.5.permissions' => 'string',
            'menus.13.subMenus.5.name' => 'string',
            'menus.13.subMenus.5.route' => 'string',
            'menus.13.subMenus.5.icon' => 'string',
            'menus.13.subMenus.5.table' => 'string',
            'menus.13.subMenus.5.sidebar' => 'boolean',
...
'menus.13.subMenus.0.roles','menus.13.subMenus.0.permissions','menus.13.subMenus.0.name','menus.13.subMenus.0.route','menus.13.subMenus.0.icon',
'menus.13.subMenus.0.table','menus.13.subMenus.0.sidebar','menus.13.subMenus.1.roles','menus.13.subMenus.1.permissions','menus.13.subMenus.1.name',
'menus.13.subMenus.1.route','menus.13.subMenus.1.icon','menus.13.subMenus.1.table','menus.13.subMenus.1.sidebar','menus.13.subMenus.2.roles',
'menus.13.subMenus.2.permissions','menus.13.subMenus.2.name','menus.13.subMenus.2.route','menus.13.subMenus.2.icon','menus.13.subMenus.2.table',
'menus.13.subMenus.2.sidebar','menus.13.subMenus.3.roles','menus.13.subMenus.3.permissions','menus.13.subMenus.3.name','menus.13.subMenus.3.route',
'menus.13.subMenus.3.icon','menus.13.subMenus.3.table','menus.13.subMenus.3.sidebar','menus.13.subMenus.4.roles','menus.13.subMenus.4.permissions',
'menus.13.subMenus.4.name','menus.13.subMenus.4.route','menus.13.subMenus.4.icon','menus.13.subMenus.4.table','menus.13.subMenus.4.sidebar',
'menus.13.subMenus.5.roles','menus.13.subMenus.5.permissions','menus.13.subMenus.5.name','menus.13.subMenus.5.route','menus.13.subMenus.5.icon',
'menus.13.subMenus.5.table','menus.13.subMenus.5.sidebar','permission.models.permission','permission.models.role','permission.table_names.roles',
...
'cms.partner.edit','cms.partner.detail','cms.history.index','cms.history.add','cms.history.edit',
'cms.history.detail','cms.career.index','cms.career.add','cms.career.edit','cms.career.detail',
'cms.career-benefit.index','cms.career-benefit.add','cms.career-benefit.edit','cms.career-benefit.detail','cms.faq.index',
'cms.faq.add','cms.faq.edit','cms.faq.detail','cms.office.index','cms.office.add',
'cms.office.edit','cms.office.detail','cms.configuration.index','cms.configuration.activity','cms.configuration.user.index',
'cms.configuration.user.add','cms.configuration.user.edit','cms.configuration.user.delete','cms.configuration.user.detail','cms.configuration.role.index',
'cms.configuration.role.add','cms.configuration.role.edit','cms.configuration.role.delete','cms.configuration.role.detail','cms.configuration.permission.index',
'cms.configuration.permission.add','cms.configuration.permission.edit','cms.configuration.permission.detail','cms.configuration.setting.index','cms.configuration.setting.add',
'cms.configuration.setting.edit','cms.configuration.setting.delete','cms.configuration.setting.detail','cms.profile.index','cms.profile.activity-log',
'cms.profile.edit-profile','cms.profile.change-password','cms.logout','storage.local',);
...
'excel.product-category','excel.slider','layouts.body','layouts.cms.body','layouts.cms.css',
'layouts.cms.script','layouts.cms.vendors','layouts.css','layouts.script','layouts.vendors',
...
'livewire-charts::livewire-pie-chart','livewire-charts::livewire-radar-chart','livewire-charts::livewire-radial-chart','livewire-charts::livewire-tree-map-chart','livewire.about.index',
'livewire.article.index','livewire.article.sidebar-right','livewire.article.view','livewire.banner','livewire.career.index',
'livewire.cms.article.add','livewire.cms.article.detail','livewire.cms.article.edit','livewire.cms.article.index','livewire.cms.career-benefit.add',
'livewire.cms.career-benefit.detail','livewire.cms.career-benefit.edit','livewire.cms.career-benefit.index','livewire.cms.career.add','livewire.cms.career.detail',
'livewire.cms.career.edit','livewire.cms.career.index','livewire.cms.configuration.permission.add','livewire.cms.configuration.permission.detail','livewire.cms.configuration.permission.edit',
'livewire.cms.configuration.permission.index','livewire.cms.configuration.permission.role','livewire.cms.configuration.permission.user','livewire.cms.contact.detail','livewire.cms.contact.index',
'livewire.cms.faq.add','livewire.cms.faq.detail','livewire.cms.faq.edit','livewire.cms.faq.index','livewire.cms.forgot-password.index',
'livewire.cms.gallery-category.add','livewire.cms.gallery-category.detail','livewire.cms.gallery-category.edit','livewire.cms.gallery-category.index','livewire.cms.gallery.add',
'livewire.cms.gallery.detail','livewire.cms.gallery.edit','livewire.cms.gallery.index','livewire.cms.history.add','livewire.cms.history.detail',
'livewire.cms.history.edit','livewire.cms.history.index','livewire.cms.home.index','livewire.cms.home.menu','livewire.cms.layouts.error',
'livewire.cms.layouts.footer','livewire.cms.layouts.header','livewire.cms.layouts.language','livewire.cms.layouts.profile','livewire.cms.layouts.search-menu',
'livewire.cms.layouts.server-time','livewire.cms.layouts.sidebar','livewire.cms.layouts.theme','livewire.cms.loader','livewire.cms.login.index',
'livewire.cms.office.add','livewire.cms.office.detail','livewire.cms.office.edit','livewire.cms.office.index','livewire.cms.partner.add',
'livewire.cms.partner.detail','livewire.cms.partner.edit','livewire.cms.partner.index','livewire.cms.product-category.add','livewire.cms.product-category.detail',
'livewire.cms.product-category.edit','livewire.cms.product-category.index','livewire.cms.product.add','livewire.cms.product.detail','livewire.cms.product.edit',
'livewire.cms.product.index','livewire.cms.profile.activity-log','livewire.cms.profile.change-password','livewire.cms.profile.edit-profile','livewire.cms.profile.index',
'livewire.cms.profile.menu','livewire.cms.slider.add','livewire.cms.slider.detail','livewire.cms.slider.edit','livewire.cms.slider.index',
...
'validation.attributes.file_msds','validation.attributes.product_category_id','validation.attributes.index','validation.success','index.#',
'index.about','index.action','index.active','index.activity_log','index.activity',
'index.add','index.all_right_reserved','index.all_rights_reserved','index.all','index.and',
'index.apply_online','index.article','index.attributes','index.auto','index.back_to_home',
'index.back_to_login','index.back','index.banner','index.call','index.career',
...
'index.export_to_excel','index.export_to_pdf','index.failed','index.faq','index.featured_product',
'index.fields_has_been_successfully_reseted','index.find_opportunities','index.flag','index.forgot_password_failed','index.forgot_password_success',
'index.forgot_password','index.form_validation','index.format','index.frequently_asked_questions','index.gallery',
...
'index.image','index.indonesia','index.last_activity','index.latest_article','index.learn_more',
'index.light','index.login_failed','index.login_has_been_successfully','index.login_success','index.login',
'index.logo','index.logout_failed','index.logout_success','index.logout','index.menu',
'index.message','index.my_profile','index.name_id','index.name_zh','index.name',
'index.new_password','index.new','index.next','index.no_data_available','index.no',
'index.not_found','index.office','index.old','index.other_articles','index.other_product',
'index.our_gallery','index.our_history','index.our_latest_product','index.our_mission','index.our_partner',
'index.our_product_category','index.our_product','index.our_team','index.our_vision','index.page_has_been_successfully_refreshed',
'index.partner','index.permission','index.phone','index.please_try_again_later','index.previous',
'index.printed_date','index.product_category','index.product','index.profile','index.quick_contact',
'index.quick_links','index.read_more','index.recent_articles','index.refresh','index.reserves',
'index.reset_filter','index.reset','index.resource','index.resources','index.role',
'index.roles_and_permissions','index.save','index.search','index.select','index.send_request',
'index.server_time','index.setting','index.size','index.slug','index.stay_login',
...
'index.your_phone','index.your_profile_has_been_successfully_updated','index.example','index.link','index.location',
'index.location_id','index.location_zh','index.career_benefit','index.f_a_q','index.gallery_category',
'index.address','index.maps','index.file_coa','index.file_msds','index.slider',
'index.index',);
