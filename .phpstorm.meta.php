...
'locale','index','about','contact','storage.local',);
...
'livewire.about.index','livewire.contact.index','livewire.home.index','livewire.layouts.error','livewire.layouts.footer',
'livewire.layouts.header','livewire.layouts.topbar','livewire::bootstrap','livewire::simple-bootstrap','livewire::simple-tailwind',
...
'index.change_language','index.english','index.indonesia','index.chinese','index.submit',
'index.thank_you_for_contacting_us_we_will_reply_to_your_message_as_soon_as_possible','index.office','index.email','index.home','index.menu',
'index.our_latest_product','index.phone','index.product_category','index.quick_links',);
