...
'livewire.product.category','livewire.product.index','livewire.product.view','livewire.quick-contact','livewire.testimony.index',
...
'components::components.button.export-to-pdf','components::components.button.inactive','components::components.button.pdf','components::components.button.print','components::components.button.restore',
...
'components::components.form.whatsapp','components::components.iframe','components::components.image','components::components.layouts.app','components::components.layouts.breadcrumbs',
...
'components::components.search.date','components::components.search.enum','components::components.search.icon','components::components.search.is-active','components::components.search.select',
...
'index.download','index.email','index.english','index.faq','index.frequently_asked_questions',
'index.form_validation','index.gallery','index.get_in_touch','index.home','index.indonesia',
'index.latest_article','index.learn_more','index.menu','index.next','index.not_found',
'index.office','index.our_gallery','index.our_latest_product','index.our_partner','index.our_product_category',
...
'index.submit','index.testimony','index.thank_you_for_contacting_us_we_will_reply_to_your_message_as_soon_as_possible','index.thank_you_for_contacting_us','index.total',
'index.view','index.warehouse','index.your_name','index.your_company','index.your_email',
'index.your_phone','index.write_subject','index.write_message','index.your_message_has_been_received_successfully_we_appreciate_you_reaching_out_and_will_get_back_to_you_as_soon_as_possible',);
