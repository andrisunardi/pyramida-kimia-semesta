...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'menus.12.subMenus.0.roles' => 'string',
            'menus.12.subMenus.0.permissions' => 'string',
            'menus.12.subMenus.0.name' => 'string',
            'menus.12.subMenus.0.route' => 'string',
            'menus.12.subMenus.0.icon' => 'string',
            'menus.12.subMenus.0.table' => 'NULL',
            'menus.12.subMenus.0.sidebar' => 'boolean',
            'menus.12.subMenus.1.roles' => 'string',
            'menus.12.subMenus.1.permissions' => 'string',
            'menus.12.subMenus.1.name' => 'string',
            'menus.12.subMenus.1.route' => 'string',
            'menus.12.subMenus.1.icon' => 'string',
            'menus.12.subMenus.1.table' => 'string',
            'menus.12.subMenus.1.sidebar' => 'boolean',
            'menus.12.subMenus.2.roles' => 'string',
            'menus.12.subMenus.2.permissions' => 'string',
            'menus.12.subMenus.2.name' => 'string',
            'menus.12.subMenus.2.route' => 'string',
            'menus.12.subMenus.2.icon' => 'string',
            'menus.12.subMenus.2.table' => 'string',
            'menus.12.subMenus.2.sidebar' => 'boolean',
            'menus.12.subMenus.3.roles' => 'string',
            'menus.12.subMenus.3.permissions' => 'string',
            'menus.12.subMenus.3.name' => 'string',
            'menus.12.subMenus.3.route' => 'string',
            'menus.12.subMenus.3.icon' => 'string',
            'menus.12.subMenus.3.table' => 'string',
            'menus.12.subMenus.3.sidebar' => 'boolean',
            'menus.12.subMenus.4.roles' => 'string',
            'menus.12.subMenus.4.permissions' => 'string',
            'menus.12.subMenus.4.name' => 'string',
            'menus.12.subMenus.4.route' => 'string',
            'menus.12.subMenus.4.icon' => 'string',
            'menus.12.subMenus.4.table' => 'string',
            'menus.12.subMenus.4.sidebar' => 'boolean',
            'menus.12.subMenus.5.roles' => 'string',
            'menus.12.subMenus.5.permissions' => 'string',
            'menus.12.subMenus.5.name' => 'string',
            'menus.12.subMenus.5.route' => 'string',
            'menus.12.subMenus.5.icon' => 'string',
            'menus.12.subMenus.5.table' => 'string',
            'menus.12.subMenus.5.sidebar' => 'boolean',
...
'menus.12.table','menus.12.sidebar','menus.12.subMenus.0.roles','menus.12.subMenus.0.permissions','menus.12.subMenus.0.name',
'menus.12.subMenus.0.route','menus.12.subMenus.0.icon','menus.12.subMenus.0.table','menus.12.subMenus.0.sidebar','menus.12.subMenus.1.roles',
'menus.12.subMenus.1.permissions','menus.12.subMenus.1.name','menus.12.subMenus.1.route','menus.12.subMenus.1.icon','menus.12.subMenus.1.table',
'menus.12.subMenus.1.sidebar','menus.12.subMenus.2.roles','menus.12.subMenus.2.permissions','menus.12.subMenus.2.name','menus.12.subMenus.2.route',
'menus.12.subMenus.2.icon','menus.12.subMenus.2.table','menus.12.subMenus.2.sidebar','menus.12.subMenus.3.roles','menus.12.subMenus.3.permissions',
'menus.12.subMenus.3.name','menus.12.subMenus.3.route','menus.12.subMenus.3.icon','menus.12.subMenus.3.table','menus.12.subMenus.3.sidebar',
'menus.12.subMenus.4.roles','menus.12.subMenus.4.permissions','menus.12.subMenus.4.name','menus.12.subMenus.4.route','menus.12.subMenus.4.icon',
'menus.12.subMenus.4.table','menus.12.subMenus.4.sidebar','menus.12.subMenus.5.roles','menus.12.subMenus.5.permissions','menus.12.subMenus.5.name',
'menus.12.subMenus.5.route','menus.12.subMenus.5.icon','menus.12.subMenus.5.table','menus.12.subMenus.5.sidebar','permission.models.permission',
...
'permission.cache.key','permission.cache.store','permission.permission.wildcard_permission','pretty-routes.url','pretty-routes.middlewares',
...
'queue.failed.table','reverb.default','reverb.servers.reverb.host','reverb.servers.reverb.port','reverb.servers.reverb.hostname',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\ViewWatcher','tinker.commands','tinker.alias','tinker.dont_alias','hashing.driver',
...
'cors.exposed_headers','cors.max_age','cors.supports_credentials',);
...
'cms.gallery-category.index','cms.gallery-category.add','cms.gallery-category.edit','cms.gallery-category.detail','cms.partner.index',
'cms.partner.add','cms.partner.edit','cms.partner.detail','cms.history.index','cms.history.add',
'cms.history.edit','cms.history.detail','cms.career.index','cms.career.add','cms.career.edit',
'cms.career.detail','cms.career-benefit.index','cms.career-benefit.add','cms.career-benefit.edit','cms.career-benefit.detail',
'cms.faq.index','cms.faq.add','cms.faq.edit','cms.faq.detail','cms.office.index',
'cms.office.add','cms.office.edit','cms.office.detail','cms.configuration.index','cms.configuration.activity',
'cms.configuration.user.index','cms.configuration.user.add','cms.configuration.user.edit','cms.configuration.user.delete','cms.configuration.user.detail',
'cms.configuration.role.index','cms.configuration.role.add','cms.configuration.role.edit','cms.configuration.role.delete','cms.configuration.role.detail',
'cms.configuration.permission.index','cms.configuration.permission.add','cms.configuration.permission.edit','cms.configuration.permission.detail','cms.configuration.setting.index',
'cms.configuration.setting.add','cms.configuration.setting.edit','cms.configuration.setting.delete','cms.configuration.setting.detail','cms.profile.index',
'cms.profile.activity-log','cms.profile.edit-profile','cms.profile.change-password','cms.logout','storage.local',);
...
'excel.product-category','layouts.body','layouts.cms.body','layouts.cms.css','layouts.cms.script',
'layouts.cms.vendors','layouts.css','layouts.script','layouts.vendors','livewire-charts::livewire-area-chart',
...
'livewire-charts::livewire-radar-chart','livewire-charts::livewire-radial-chart','livewire-charts::livewire-tree-map-chart','livewire.about.index','livewire.article.index',
'livewire.article.sidebar-right','livewire.article.view','livewire.banner','livewire.career.index','livewire.cms.article.add',
'livewire.cms.article.detail','livewire.cms.article.edit','livewire.cms.article.index','livewire.cms.career-benefit.add','livewire.cms.career-benefit.detail',
'livewire.cms.career-benefit.edit','livewire.cms.career-benefit.index','livewire.cms.career.add','livewire.cms.career.detail','livewire.cms.career.edit',
'livewire.cms.career.index','livewire.cms.configuration.permission.add','livewire.cms.configuration.permission.detail','livewire.cms.configuration.permission.edit','livewire.cms.configuration.permission.index',
'livewire.cms.configuration.permission.role','livewire.cms.configuration.permission.user','livewire.cms.contact.detail','livewire.cms.contact.index','livewire.cms.faq.add',
'livewire.cms.faq.detail','livewire.cms.faq.edit','livewire.cms.faq.index','livewire.cms.forgot-password.index','livewire.cms.gallery-category.add',
'livewire.cms.gallery-category.detail','livewire.cms.gallery-category.edit','livewire.cms.gallery-category.index','livewire.cms.gallery.add','livewire.cms.gallery.detail',
'livewire.cms.gallery.edit','livewire.cms.gallery.index','livewire.cms.history.add','livewire.cms.history.detail','livewire.cms.history.edit',
'livewire.cms.history.index','livewire.cms.home.index','livewire.cms.home.menu','livewire.cms.layouts.error','livewire.cms.layouts.footer',
'livewire.cms.layouts.header','livewire.cms.layouts.language','livewire.cms.layouts.profile','livewire.cms.layouts.search-menu','livewire.cms.layouts.server-time',
'livewire.cms.layouts.sidebar','livewire.cms.layouts.theme','livewire.cms.loader','livewire.cms.login.index','livewire.cms.office.add',
'livewire.cms.office.detail','livewire.cms.office.edit','livewire.cms.office.index','livewire.cms.partner.add','livewire.cms.partner.detail',
'livewire.cms.partner.edit','livewire.cms.partner.index','livewire.cms.product-category.add','livewire.cms.product-category.detail','livewire.cms.product-category.edit',
'livewire.cms.product-category.index','livewire.cms.product.add','livewire.cms.product.detail','livewire.cms.product.edit','livewire.cms.product.index',
'livewire.cms.profile.activity-log','livewire.cms.profile.change-password','livewire.cms.profile.edit-profile','livewire.cms.profile.index','livewire.cms.profile.menu',
...
'index.address','index.maps','index.file_coa','index.file_msds','index.index',);
