...
'livewire.contact.index','livewire.faq.index','livewire.gallery.index','livewire.home.article','livewire.home.index',
'livewire.home.partner','livewire.home.product','livewire.home.product-category','livewire.home.slider','livewire.home.testimony',
'livewire.layouts.error','livewire.layouts.footer','livewire.layouts.header','livewire.layouts.topbar','livewire.product.category',
'livewire.product.index','livewire.product.view','livewire.quick-contact','livewire.testimony.index','livewire::bootstrap',
...
'components::components.button.inactive','components::components.button.pdf','components::components.button.print','components::components.button.restore','components::components.button.upload',
...
'components::components.form.checkbox','components::components.form.code','components::components.form.company','components::components.form.date','components::components.form.description',
...
'index.download','index.email','index.english','index.faq','index.form_validation',
...
'index.product','index.quick_contact','index.quick_links','index.read_more','index.submit',
...
'index.warehouse','index.your_name','index.your_company','index.your_email','index.your_phone',
'index.write_subject','index.write_message','index.your_message_has_been_received_successfully_we_appreciate_you_reaching_out_and_will_get_back_to_you_as_soon_as_possible',);
