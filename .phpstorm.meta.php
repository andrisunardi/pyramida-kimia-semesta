...
'testimony','product.index','product.category','product.view','article.index',
'article.view','gallery','faq','contact','storage.local',);
...
'livewire.sidebar-right','livewire.testimony.index','livewire::bootstrap','livewire::simple-bootstrap','livewire::simple-tailwind',
...
'index.history','index.our_history',);
