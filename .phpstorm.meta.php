...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'menus.9.subMenus.0.roles' => 'string',
            'menus.9.subMenus.0.permissions' => 'string',
            'menus.9.subMenus.0.name' => 'string',
            'menus.9.subMenus.0.route' => 'string',
            'menus.9.subMenus.0.icon' => 'string',
            'menus.9.subMenus.0.table' => 'NULL',
            'menus.9.subMenus.0.sidebar' => 'boolean',
            'menus.9.subMenus.1.roles' => 'string',
            'menus.9.subMenus.1.permissions' => 'string',
            'menus.9.subMenus.1.name' => 'string',
            'menus.9.subMenus.1.route' => 'string',
            'menus.9.subMenus.1.icon' => 'string',
            'menus.9.subMenus.1.table' => 'string',
            'menus.9.subMenus.1.sidebar' => 'boolean',
            'menus.9.subMenus.2.roles' => 'string',
            'menus.9.subMenus.2.permissions' => 'string',
            'menus.9.subMenus.2.name' => 'string',
            'menus.9.subMenus.2.route' => 'string',
            'menus.9.subMenus.2.icon' => 'string',
            'menus.9.subMenus.2.table' => 'string',
            'menus.9.subMenus.2.sidebar' => 'boolean',
            'menus.9.subMenus.3.roles' => 'string',
            'menus.9.subMenus.3.permissions' => 'string',
            'menus.9.subMenus.3.name' => 'string',
            'menus.9.subMenus.3.route' => 'string',
            'menus.9.subMenus.3.icon' => 'string',
            'menus.9.subMenus.3.table' => 'string',
            'menus.9.subMenus.3.sidebar' => 'boolean',
            'menus.9.subMenus.4.roles' => 'string',
            'menus.9.subMenus.4.permissions' => 'string',
            'menus.9.subMenus.4.name' => 'string',
            'menus.9.subMenus.4.route' => 'string',
            'menus.9.subMenus.4.icon' => 'string',
            'menus.9.subMenus.4.table' => 'string',
            'menus.9.subMenus.4.sidebar' => 'boolean',
            'menus.9.subMenus.5.roles' => 'string',
            'menus.9.subMenus.5.permissions' => 'string',
            'menus.9.subMenus.5.name' => 'string',
            'menus.9.subMenus.5.route' => 'string',
            'menus.9.subMenus.5.icon' => 'string',
            'menus.9.subMenus.5.table' => 'string',
            'menus.9.subMenus.5.sidebar' => 'boolean',
...
'menus.9.icon','menus.9.table','menus.9.sidebar','menus.9.subMenus.0.roles','menus.9.subMenus.0.permissions',
'menus.9.subMenus.0.name','menus.9.subMenus.0.route','menus.9.subMenus.0.icon','menus.9.subMenus.0.table','menus.9.subMenus.0.sidebar',
'menus.9.subMenus.1.roles','menus.9.subMenus.1.permissions','menus.9.subMenus.1.name','menus.9.subMenus.1.route','menus.9.subMenus.1.icon',
'menus.9.subMenus.1.table','menus.9.subMenus.1.sidebar','menus.9.subMenus.2.roles','menus.9.subMenus.2.permissions','menus.9.subMenus.2.name',
'menus.9.subMenus.2.route','menus.9.subMenus.2.icon','menus.9.subMenus.2.table','menus.9.subMenus.2.sidebar','menus.9.subMenus.3.roles',
'menus.9.subMenus.3.permissions','menus.9.subMenus.3.name','menus.9.subMenus.3.route','menus.9.subMenus.3.icon','menus.9.subMenus.3.table',
'menus.9.subMenus.3.sidebar','menus.9.subMenus.4.roles','menus.9.subMenus.4.permissions','menus.9.subMenus.4.name','menus.9.subMenus.4.route',
'menus.9.subMenus.4.icon','menus.9.subMenus.4.table','menus.9.subMenus.4.sidebar','menus.9.subMenus.5.roles','menus.9.subMenus.5.permissions',
'menus.9.subMenus.5.name','menus.9.subMenus.5.route','menus.9.subMenus.5.icon','menus.9.subMenus.5.table','menus.9.subMenus.5.sidebar',
...
'cms.gallery-category.detail','cms.history.index','cms.history.add','cms.history.edit','cms.history.detail',
...
'excel.permission','excel.permission.role','excel.permission.user','layouts.body','layouts.cms.body',
