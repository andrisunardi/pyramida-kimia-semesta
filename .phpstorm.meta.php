...
'testimony','product.index','product.category','product.view','gallery',
'faq','career','article.index','article.view','contact',
'enquire','storage.local',);
...
'livewire.layouts.topbar','livewire.menu-sidebar','livewire.product.category','livewire.product.index','livewire.product.view',
'livewire.quick-contact','livewire.resource.index','livewire.sidebar-right','livewire.testimony.index','livewire::bootstrap',
...
'index.your_phone','index.career','index.find_opportunities','index.apply_online',);
