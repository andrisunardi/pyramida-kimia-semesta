...
'errors.minimal','excel.contact','excel.permission','excel.permission.role','excel.permission.user',
...
'livewire.article.view','livewire.banner','livewire.career.index','livewire.cms.configuration.permission.add','livewire.cms.configuration.permission.detail',
'livewire.cms.configuration.permission.edit','livewire.cms.configuration.permission.index','livewire.cms.configuration.permission.role','livewire.cms.configuration.permission.user','livewire.cms.contact.add',
'livewire.cms.contact.clone','livewire.cms.contact.edit','livewire.cms.contact.index','livewire.cms.contact.trash','livewire.cms.contact.view',
'livewire.cms.forgot-password.index','livewire.cms.home.index','livewire.cms.layouts.error','livewire.cms.layouts.footer','livewire.cms.layouts.header',
...
'livewire.cms.layouts.theme','livewire.cms.loader','livewire.cms.login.index','livewire.cms.profile.activity-log','livewire.cms.profile.change-password',
'livewire.cms.profile.edit-profile','livewire.cms.profile.index','livewire.cms.profile.menu','livewire.contact.index','livewire.enquire.index',
'livewire.faq.index','livewire.featured-product','livewire.gallery.index','livewire.history.index','livewire.home.article',
'livewire.home.index','livewire.home.partner','livewire.home.product','livewire.home.product-category','livewire.home.slider',
'livewire.home.testimony','livewire.layouts.error','livewire.layouts.footer','livewire.layouts.header','livewire.layouts.topbar',
'livewire.menu-sidebar','livewire.partner.index','livewire.product.category','livewire.product.index','livewire.product.view',
'livewire.quick-contact','livewire.resource.index','livewire.sidebar-right','livewire.team.index','livewire.team.view',
'livewire.testimony.index','livewire::bootstrap','livewire::simple-bootstrap','livewire::simple-tailwind','livewire::tailwind',
...
'pagination::tailwind','vendor.breadcrumbs.bootstrap4','vendor.breadcrumbs.bootstrap5','vendor.breadcrumbs.bulma','vendor.breadcrumbs.foundation6',
'vendor.breadcrumbs.materialize','vendor.breadcrumbs.tailwind','vendor.breadcrumbs.uikit','vendor.livewire-charts.livewire-area-chart','vendor.livewire-charts.livewire-column-chart',
'vendor.livewire-charts.livewire-line-chart','vendor.livewire-charts.livewire-multi-column-chart','vendor.livewire-charts.livewire-multi-line-chart','vendor.livewire-charts.livewire-pie-chart','vendor.livewire-charts.livewire-radar-chart',
'vendor.livewire-charts.livewire-radial-chart','vendor.livewire-charts.livewire-tree-map-chart','vendor.livewire.bootstrap','vendor.livewire.simple-bootstrap','vendor.livewire.simple-tailwind',
...
'vendors.clarity-microsoft-tag','vendors.disabled-ctrl-u-and-f12','vendors.disabled-right-click','vendors.disabled-right-click-image','vendors.disabled-zoom',
'vendors.facebook-page','vendors.font-awesome','vendors.getbutton-io','vendors.google-adsense','vendors.google-analytics',
'vendors.google-tag-manager','vendors.jquery','vendors.livechat-tawk','vendors.lozad','vendors.pace',
'vendors.select2','vendors.snowflakes','breadcrumbs::bootstrap4','breadcrumbs::bootstrap5','breadcrumbs::bulma',
'breadcrumbs::foundation6','breadcrumbs::materialize','breadcrumbs::tailwind','breadcrumbs::uikit','components::components.alert',
'components::components.button','components::components.button.active','components::components.button.cancel','components::components.button.deactive','components::components.button.delete',
'components::components.button.delete-permanent','components::components.button.disable','components::components.button.download','components::components.button.edit','components::components.button.excel',
'components::components.button.export-to-excel','components::components.button.export-to-pdf','components::components.button.inactive','components::components.button.pdf','components::components.button.print',
'components::components.button.refresh','components::components.button.restore','components::components.button.sync','components::components.button.upload','components::components.button.void',
'components::components.form.address','components::components.form.alert','components::components.form.body','components::components.form.boolean','components::components.form.checkbox',
'components::components.form.code','components::components.form.company','components::components.form.date','components::components.form.datetime','components::components.form.description',
'components::components.form.email','components::components.form.enum','components::components.form.file','components::components.form.icon','components::components.form.image',
'components::components.form.input','components::components.form.is-active','components::components.form.label','components::components.form.link','components::components.form.location',
'components::components.form.message','components::components.form.name','components::components.form.notes','components::components.form.number','components::components.form.password',
'components::components.form.percentage','components::components.form.phone','components::components.form.price','components::components.form.radio','components::components.form.reset',
'components::components.form.save','components::components.form.save-changes','components::components.form.select','components::components.form.subject','components::components.form.submit',
'components::components.form.switch','components::components.form.text','components::components.form.textarea','components::components.form.time','components::components.form.title',
'components::components.form.url','components::components.form.username','components::components.form.video','components::components.form.website','components::components.form.whatsapp',
'components::components.icon','components::components.iframe','components::components.image','components::components.layouts.app','components::components.layouts.breadcrumbs',
'components::components.layouts.breadcrumbs-render','components::components.layouts.meta','components::components.layouts.pagination','components::components.link','components::components.link.active',
'components::components.link.add','components::components.link.back','components::components.link.button','components::components.link.clone','components::components.link.create',
'components::components.link.deactive','components::components.link.delete','components::components.link.delete-permanent','components::components.link.delete-permanent-all','components::components.link.detail',
'components::components.link.download','components::components.link.edit','components::components.link.email','components::components.link.external-link','components::components.link.fax',
'components::components.link.phone','components::components.link.previous','components::components.link.print','components::components.link.relation','components::components.link.restore',
'components::components.link.restore-all','components::components.link.sms','components::components.link.store','components::components.link.switch','components::components.link.tel',
'components::components.link.total','components::components.link.trash','components::components.link.update','components::components.link.user','components::components.link.view',
'components::components.link.whatsapp','components::components.preview.file','components::components.preview.image','components::components.preview.video','components::components.search',
'components::components.search.boolean','components::components.search.date','components::components.search.datetime','components::components.search.enum','components::components.search.icon',
'components::components.search.is-active','components::components.search.select','components::components.search.time','components::components.video','components::components.youtube',
'horizon::layout','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor','laravel-exceptions-renderer::components.header',
...
'laravel-exceptions::minimal','livewire-alert::components.flash','livewire-alert::components.scripts','livewire-charts::livewire-area-chart','livewire-charts::livewire-column-chart',
'livewire-charts::livewire-line-chart','livewire-charts::livewire-multi-column-chart','livewire-charts::livewire-multi-line-chart','livewire-charts::livewire-pie-chart','livewire-charts::livewire-radar-chart',
