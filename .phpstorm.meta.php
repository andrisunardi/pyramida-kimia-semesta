...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'menus.1.subMenus.0.roles' => 'string',
            'menus.1.subMenus.0.permissions' => 'string',
            'menus.1.subMenus.0.name' => 'string',
            'menus.1.subMenus.0.route' => 'string',
            'menus.1.subMenus.0.icon' => 'string',
            'menus.1.subMenus.0.table' => 'NULL',
            'menus.1.subMenus.0.sidebar' => 'boolean',
            'menus.1.subMenus.1.roles' => 'string',
            'menus.1.subMenus.1.permissions' => 'string',
            'menus.1.subMenus.1.name' => 'string',
            'menus.1.subMenus.1.route' => 'string',
            'menus.1.subMenus.1.icon' => 'string',
            'menus.1.subMenus.1.table' => 'string',
            'menus.1.subMenus.1.sidebar' => 'boolean',
            'menus.1.subMenus.2.roles' => 'string',
            'menus.1.subMenus.2.permissions' => 'string',
            'menus.1.subMenus.2.name' => 'string',
            'menus.1.subMenus.2.route' => 'string',
            'menus.1.subMenus.2.icon' => 'string',
            'menus.1.subMenus.2.table' => 'string',
            'menus.1.subMenus.2.sidebar' => 'boolean',
            'menus.1.subMenus.3.roles' => 'string',
            'menus.1.subMenus.3.permissions' => 'string',
            'menus.1.subMenus.3.name' => 'string',
            'menus.1.subMenus.3.route' => 'string',
            'menus.1.subMenus.3.icon' => 'string',
            'menus.1.subMenus.3.table' => 'string',
            'menus.1.subMenus.3.sidebar' => 'boolean',
            'menus.1.subMenus.4.roles' => 'string',
            'menus.1.subMenus.4.permissions' => 'string',
            'menus.1.subMenus.4.name' => 'string',
            'menus.1.subMenus.4.route' => 'string',
            'menus.1.subMenus.4.icon' => 'string',
            'menus.1.subMenus.4.table' => 'string',
            'menus.1.subMenus.4.sidebar' => 'boolean',
            'menus.1.subMenus.5.roles' => 'string',
            'menus.1.subMenus.5.permissions' => 'string',
            'menus.1.subMenus.5.name' => 'string',
            'menus.1.subMenus.5.route' => 'string',
            'menus.1.subMenus.5.icon' => 'string',
            'menus.1.subMenus.5.table' => 'string',
            'menus.1.subMenus.5.sidebar' => 'boolean',
...
'menus.1.route','menus.1.icon','menus.1.table','menus.1.sidebar','menus.1.subMenus.0.roles',
'menus.1.subMenus.0.permissions','menus.1.subMenus.0.name','menus.1.subMenus.0.route','menus.1.subMenus.0.icon','menus.1.subMenus.0.table',
'menus.1.subMenus.0.sidebar','menus.1.subMenus.1.roles','menus.1.subMenus.1.permissions','menus.1.subMenus.1.name','menus.1.subMenus.1.route',
'menus.1.subMenus.1.icon','menus.1.subMenus.1.table','menus.1.subMenus.1.sidebar','menus.1.subMenus.2.roles','menus.1.subMenus.2.permissions',
'menus.1.subMenus.2.name','menus.1.subMenus.2.route','menus.1.subMenus.2.icon','menus.1.subMenus.2.table','menus.1.subMenus.2.sidebar',
'menus.1.subMenus.3.roles','menus.1.subMenus.3.permissions','menus.1.subMenus.3.name','menus.1.subMenus.3.route','menus.1.subMenus.3.icon',
'menus.1.subMenus.3.table','menus.1.subMenus.3.sidebar','menus.1.subMenus.4.roles','menus.1.subMenus.4.permissions','menus.1.subMenus.4.name',
'menus.1.subMenus.4.route','menus.1.subMenus.4.icon','menus.1.subMenus.4.table','menus.1.subMenus.4.sidebar','menus.1.subMenus.5.roles',
'menus.1.subMenus.5.permissions','menus.1.subMenus.5.name','menus.1.subMenus.5.route','menus.1.subMenus.5.icon','menus.1.subMenus.5.table',
'menus.1.subMenus.5.sidebar','permission.models.permission','permission.models.role','permission.table_names.roles','permission.table_names.permissions',
...
'cms.forgot-password','cms.index','cms.contact.index','cms.contact.detail','cms.configuration.index',
'cms.configuration.activity','cms.configuration.user.index','cms.configuration.user.add','cms.configuration.user.clone','cms.configuration.user.edit',
'cms.configuration.user.active','cms.configuration.user.delete','cms.configuration.user.delete-image','cms.configuration.user.view','cms.configuration.user.trash',
'cms.configuration.user.restore','cms.configuration.user.delete-permanent','cms.configuration.user.restore-all','cms.configuration.user.delete-permanent-all','cms.configuration.role.index',
'cms.configuration.role.add','cms.configuration.role.clone','cms.configuration.role.edit','cms.configuration.role.delete','cms.configuration.role.view',
...
'cms.configuration.setting.add','cms.configuration.setting.clone','cms.configuration.setting.edit','cms.configuration.setting.active','cms.configuration.setting.delete',
'cms.configuration.setting.view','cms.configuration.setting.trash','cms.configuration.setting.restore','cms.configuration.setting.delete-permanent','cms.configuration.setting.restore-all',
'cms.configuration.setting.delete-permanent-all','cms.profile.index','cms.profile.activity-log','cms.profile.edit-profile','cms.profile.change-password',
...
'errors.minimal','excel.contact','excel.permission','layouts.body','layouts.cms.body',
...
'livewire.career.index','livewire.cms.configuration.permission.add','livewire.cms.configuration.permission.detail','livewire.cms.configuration.permission.edit','livewire.cms.configuration.permission.index',
'livewire.cms.configuration.permission.role','livewire.cms.configuration.permission.user','livewire.cms.contact.add','livewire.cms.contact.clone','livewire.cms.contact.edit',
'livewire.cms.contact.index','livewire.cms.contact.trash','livewire.cms.contact.view','livewire.cms.forgot-password.index','livewire.cms.home.index',
...
'livewire.cms.layouts.search-menu','livewire.cms.layouts.server-time','livewire.cms.layouts.sidebar','livewire.cms.layouts.theme','livewire.cms.login.index',
...
'validation.attributes.current_password','validation.attributes.email','validation.attributes.guard_name','validation.attributes.image','validation.attributes.is_active',
'validation.attributes.message','validation.attributes.name','validation.attributes.new_password','validation.attributes.password','validation.attributes.phone',
'validation.attributes.role','validation.attributes.search','validation.attributes.subject','validation.attributes.user','validation.attributes.username',
...
'index.change_password','index.chinese','index.clone','index.company_profile','index.company',
...
'index.delete','index.detail','index.download','index.edit_profile','index.edit',
...
'index.has_been_successfully_added','index.has_been_successfully_deleted','index.has_been_successfully_edited','index.history','index.home',
...
'index.menu','index.message','index.my_profile','index.name','index.new_password',
...
'index.permission','index.phone','index.please_try_again_later','index.previous','index.product_category',
...
'index.resource','index.resources','index.role','index.roles_and_permissions','index.search',
'index.send_request','index.server_time','index.setting','index.size','index.stay_login',
'index.subject','index.submit','index.success','index.tags','index.team',
