...
<meta http-equiv="refresh" content="{{ env('APP_REFRESH') }}" />
...
<meta name="viewport"
    content="width=device-width, height=device-height, user-scalable=no, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0, shrink-to-fit=no" />
...
<meta name="msapplication-task"
    content="name={{ env('APP_NAME') }}; action-uri={{ URL::to('/') }}; icon-uri={{ URL::to('/') }}/images/tile/tile.png" />
