            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    @can('permission.delete')
                        <div class="col-6 col-sm-auto">
                            <x-components::button.delete :size="'md'" :width="'100'" :key="'delete(' . $permission->id . ')'" :confirm="'Are you sure you want to delete this Permission'" />
                        </div>
                    @endcan
                </div>
            </div>
        ...
        <div class="tab-content" id="pills-tabContent">
            @can('role')
                <div class="tab-pane fade show active" id="pills-role" role="tabpanel">
                    @livewire('permission.permission-role-component', ['permission' => $permission])
                </div>
            @endcan

            @can('user')
                <div class="tab-pane fade" id="pills-user" role="tabpanel">
                    @livewire('permission.permission-user-component', ['permission' => $permission])
                </div>
            @endcan
        </div>
    </div>
