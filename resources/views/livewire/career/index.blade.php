...
<main>
            ...
            <div class="content row">
                <div class="row">
                    <div class="col-md-8 res-m-bttm">
                        ...
                        <p>
                            Imagine being surrounded by a team dolor sit amet consectetur to adipiscing elit, sed dot
                            eiusmod tempor incididunt labore et dolore magna aliqua. Veniam quis nostrud exercitation
    ...
    <div class="section section-contents section-pad bg-light">
        <div class="container">
            <div class="content row">
                <h3 class="center font-w-300">Currently Opening Position</h3>
                <div class="gaps"></div>
                <div class="row">
                    <div class="col-md-6 res-m-bttm-sm">
                        <div class="box-s1 box-flat-thin">
                            <h4>Mechanical Engineer</h4>
                            <p>Dolor sit amet consectetur to adipiscing elit, sed dot eiusmod tempor incididunt labore
                                et dolore magna aliqua.</p>
                            <p class="small"><em class="fa fa-map-marker"></em> Location - Boston</p>
                            <p><a href="#" class="btn btn-sm btn-outline">Apply Online</a></p>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="box-s1 box-flat-thin">
