<div id="slider" class="banner banner-slider carousel slide carousel-fade banner-large">
    ...
    <a draggable="false" class="left carousel-control" href="#slider" role="button" data-slide="prev" style="display: inherit">
        <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
        <span class="sr-only">{{ trans('index.previous') }}</span>
    </a>
    <a draggable="false" class="right carousel-control" href="#slider" role="button" data-slide="next" style="display: inherit">
